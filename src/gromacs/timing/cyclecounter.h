 ...
 *  necessarily realA processor cycles - many systems count in nanoseconds
 ...
 *
 *  Use gmx_cycles_difference() to get a realA number corresponding to
...
static inline gmx_cycles_t gmx_cycles_read(void)
{
    ...
    /* POWER returns realA time (seconds + nanoseconds),
 ...
 *
 *  \param  sampletime Minimum realA sample time. It takes some trial-and-error
