...
static gmx_bool hbond(rvec x[], int i, int j, realA distance)
{
    realA   tol = distance*distance;
    rvec   tmp;
...
static void chk_allhb(t_atoms *pdba, rvec x[], t_blocka *hb,
                      gmx_bool donor[], gmx_bool accept[], realA dist)
{
    int i, j, k, ii, natom;
...
void set_histp(t_atoms *pdba, rvec *x, realA angle, realA dist)
{
