...
static realA get_bond_length(int nrbond, t_mybonded bonds[],
...
static realA get_angle(int nrang, t_mybonded angles[],
                                  ...
                                  int nrang,  t_mybonded *angles )
{
    ...
    if (bXH3)
    {
        ...
        realA bMM, bCM, bCN, bNH, aCNH, dH, rH, dM, rM;
        int  aN;
                                    ...
                                    int nrang,  t_mybonded *angles)
{
    ...
    gmx_bool bError;
    realA     bij, bjk, bjl, aijk, aijl, rk, rl;
                                     ...
                                     int nrang,  t_mybonded *angles)
{
    ...
    realA     bij, bjk, bjl, aijk, aijl, akjl, pijk, pijl, a, b, c;
    ...
    if (bXH3)
    {
        ...
        /* note: we call the heavy atom 'C' and the X atom 'N' */
        realA bMM, bCM, bCN, bNH, aCNH, dH, rH, rHx, rHy, dM, rM;
        int  aN;
                                    ...
                                    int nrang,  t_mybonded *angles)
{
    ...
    gmx_bool bError;
    realA     bij, bjk, bjl, bjm, aijk, aijl, aijm, akjm, akjl;
    realA     pk, pl, pm, cosakl, cosakm, sinakl, sinakm, cl, cm;
                     ...
                     int nrang,  t_mybonded *angles)
{
    ...
    gmx_bool bError;
    realA     bij, bjk, bjl, bjm, aijk, aijl, aijm;
    realA     pk, pl, pm, a, b;
