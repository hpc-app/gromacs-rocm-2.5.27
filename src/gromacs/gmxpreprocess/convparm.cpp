...
static int round_check(realA r, int limit, int ftype, const char *name)
{
    int i;
...
assign_param(t_functype ftype, t_iparams *newparam,
             realA old[MAXFORCEPARAM], int comb, double reppow)
{
    int      i, j;
...
static int enter_params(gmx_ffparams_t *ffparams, t_functype ftype,
                        realA forceparams[MAXFORCEPARAM], int comb, realA reppow,
...
static void enter_function(t_params *p, t_functype ftype, int comb, realA reppow,
