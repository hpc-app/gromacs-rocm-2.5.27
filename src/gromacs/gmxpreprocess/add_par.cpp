...
static void clear_force_param(int i0, realA c[])
{
    int i;
...
void add_param(t_params *ps, int ai, int aj, realA *c, char *s)
{
    int i;
...
void add_imp_param(t_params *ps, int ai, int aj, int ak, int al, realA c0, realA c1,
                   char *s)
{
    pr_alloc(1, ps);
    ps->param[ps->nr].ai() = ai;
...
void add_dih_param(t_params *ps, int ai, int aj, int ak, int al, realA c0, realA c1,
                   realA c2, char *s)
{
    pr_alloc(1, ps);
    ps->param[ps->nr].ai() = ai;
...
void add_vsite2_param(t_params *ps, int ai, int aj, int ak, realA c0)
{
    pr_alloc(1, ps);
    ps->param[ps->nr].ai() = ai;
    ps->param[ps->nr].aj() = aj;
