...
static realA get_ddb_bond(t_vsitetop *vsitetop, int nvsitetop,
                         const char res[],
...
static realA get_ddb_angle(t_vsitetop *vsitetop, int nvsitetop,
...
static realA get_amass(int atom, t_atoms *at, int nrtp, t_restp rtp[],
                      gmx_residuetype_t *rt)
{
    realA     mass;
    gmx_bool bNterm;
...
static void my_add_param(t_params *plist, int ai, int aj, realA b)
{
    static realA c[MAXFORCEPARAM] =
...
static int gen_vsites_6ring(t_atoms *at, int *vsite_type[], t_params plist[],
                            int nrfound, int *ats, realA bond_cc, realA bond_ch,
                            realA xcom, gmx_bool bDoZ)
{
    ...
    int  i, nvsite;
    realA a, b, dCGCE, tmp1, tmp2, mtot, mG, mrest;
    realA xCG;
...
static void calc_vsite3_param(realA xd, realA yd, realA xi, realA yi, realA xj, realA yj,
                              realA xk, realA yk, realA *a, realA *b)
{
    /* determine parameters by solving the equation system, since we know the
     * virtual site coordinates here.
     */
    realA dx_ij, dx_ik, dy_ij, dy_ik;
...
#define NMASS 2
    ...
    realA xi[atNR], yi[atNR];
    realA xcom[NMASS], ycom[NMASS], alpha;
    realA b_CD2_CE2, b_NE1_CE2, b_CG_CD2, b_CH2_HH2, b_CE2_CZ2;
    realA b_NE1_HE1, b_CD2_CE3, b_CE3_CZ3, b_CB_CG;
    realA b_CZ2_CH2, b_CZ2_HZ2, b_CD1_HD1, b_CE3_HE3;
    realA b_CG_CD1, b_CZ3_HZ3;
    realA a_NE1_CE2_CD2, a_CE2_CD2_CG, a_CB_CG_CD2, a_CE2_CD2_CE3;
    realA a_CD2_CG_CD1, a_CE2_CZ2_HZ2, a_CZ2_CH2_HH2;
    realA a_CD2_CE2_CZ2, a_CD2_CE3_CZ3, a_CE3_CZ3_HZ3, a_CG_CD1_HD1;
    realA a_CE2_CZ2_CH2, a_HE1_NE1_CE2, a_CD2_CE3_HE3;
    int  atM[NMASS], tpM, i, i0, j, nvsite;
    realA mM[NMASS], dCBM1, dCBM2, dM1M2;
    realA a, b;
    ...
    *nadd += NMASS;
    ...
    /* calc initial position for dummy masses in realA (non-local) coordinates.
                          ...
                          t_vsitetop *vsitetop, int nvsitetop)
{
    ...
    realA dCGCE, dCEOH, dCGM, tmp1, a, b;
    realA bond_cc, bond_ch, bond_co, bond_oh, angle_coh;
    realA xcom, mtot;
    realA vdist, mM;
    rvec r1;
    char name[10];
...
{
    int  nvsite, i;
    realA a, b, alpha, dCGCE1, dCGNE2;
    realA sinalpha, cosalpha;
    realA xcom, ycom, mtot;
    realA mG, mrest, mCE1, mNE2;
    realA b_CG_ND1, b_ND1_CE1, b_CE1_NE2, b_CG_CD2, b_CD2_NE2;
    realA b_ND1_HD1, b_NE2_HE2, b_CE1_HE1, b_CD2_HD2;
    realA a_CG_ND1_CE1, a_CG_CD2_NE2, a_ND1_CE1_NE2, a_CE1_NE2_CD2;
    realA a_NE2_CE1_HE1, a_NE2_CD2_HD2, a_CE1_ND1_HD1, a_CE1_NE2_HE2;
    char resname[10];
...
void do_vsites(int nrtp, t_restp rtp[], gpp_atomtype_t atype,
               ...
               realA mHmult, gmx_bool bVsiteAromatics,
               const char *ffdir)
{
...
void do_h_mass(t_params *psb, int vsite_type[], t_atoms *at, realA mHmult,
               gmx_bool bDeuterate)
{
    int i, j, a;
