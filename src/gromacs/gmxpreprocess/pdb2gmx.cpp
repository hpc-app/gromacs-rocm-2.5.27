...
static void write_posres(char *fn, t_atoms *pdba, realA fc)
{
    FILE *fp;
    int   i;
...
static void process_chain(t_atoms *pdba, rvec *x,
                          ...
                          realA angle, realA distance, t_symtab *symtab,
                          int nrr, const rtprename_t *rr)
{
...
#define NFILE asize(fnm)
    ...
    realA               angle          = 135.0, distance = 0.3, posre_fc = 1000;
    realA               long_bond_dist = 0.25, short_bond_dist = 0.05;
