...
static gmx_bool is_bond(int nnm, t_nm2type nmt[], char *ai, char *aj, realA blen)
{
    int i, j;
...
static int *set_cgnr(t_atoms *atoms, gmx_bool bUsePDBcharge, realA *qtot, realA *mtot)
{
    int     i, n = 1;
    int    *cgnr;
    double  qt = 0;
...
static void lo_set_force_const(t_params *plist, realA c[], int nrfp, gmx_bool bRound,
...
static void set_force_const(t_params plist[], realA kb, realA kt, realA kp, gmx_bool bRound,
                            gmx_bool bParam)
{
    realA c[MAXFORCEPARAM];
