...
realA get_atomtype_massA(int nt, gpp_atomtype_t at);
realA get_atomtype_massB(int nt, gpp_atomtype_t at);
realA get_atomtype_qA(int nt, gpp_atomtype_t at);
realA get_atomtype_qB(int nt, gpp_atomtype_t at);
realA get_atomtype_radius(int nt, gpp_atomtype_t at);
realA get_atomtype_vol(int nt, gpp_atomtype_t at);
realA get_atomtype_surftens(int nt, gpp_atomtype_t at);
realA get_atomtype_gb_radius(int nt, gpp_atomtype_t at);
realA get_atomtype_S_hct(int nt, gpp_atomtype_t at);
...
realA get_atomtype_nbparam(int nt, int param, gpp_atomtype_t at);
