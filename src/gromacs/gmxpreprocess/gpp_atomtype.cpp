...
typedef struct gpp_atomtype {
    ...
    realA            *radius;       /* Radius for GBSA stuff                */
    realA            *vol;          /* Effective volume for GBSA            */
    realA            *surftens;     /* Surface tension with water, for GBSA */
    realA            *gb_radius;    /* Radius for Still model               */
    realA            *S_hct;        /* Overlap factor for HCT model         */
...
realA get_atomtype_massA(int nt, gpp_atomtype_t ga)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
        return NOTSET;
...
realA get_atomtype_massB(int nt, gpp_atomtype_t ga)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
        return NOTSET;
...
realA get_atomtype_qA(int nt, gpp_atomtype_t ga)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
        return NOTSET;
...
realA get_atomtype_qB(int nt, gpp_atomtype_t ga)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
        return NOTSET;
...
realA get_atomtype_radius(int nt, gpp_atomtype_t ga)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
        return NOTSET;
...
realA get_atomtype_vol(int nt, gpp_atomtype_t ga)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
        return NOTSET;
...
realA get_atomtype_surftens(int nt, gpp_atomtype_t ga)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
        return NOTSET;
...
realA get_atomtype_gb_radius(int nt, gpp_atomtype_t ga)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
        return NOTSET;
...
realA get_atomtype_S_hct(int nt, gpp_atomtype_t ga)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
        return NOTSET;
...
realA get_atomtype_nbparam(int nt, int param, gpp_atomtype_t ga)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
        return NOTSET;
...
set_atomtype_gbparam(gpp_atomtype_t ga, int i,
                     realA radius, realA vol, realA surftens,
                     realA gb_radius, realA S_hct)
{
    if ( (i < 0) || (i >= ga->nr))
    {
        return NOTSET;
...
int set_atomtype(int nt, gpp_atomtype_t ga, t_symtab *tab,
                 ...
                 int bondatomtype,
                 realA radius, realA vol, realA surftens, int atomnumber,
                 realA gb_radius, realA S_hct)
{
    if ((nt < 0) || (nt >= ga->nr))
    {
