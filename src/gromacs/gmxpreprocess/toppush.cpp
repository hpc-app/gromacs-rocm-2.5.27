                       ...
                       warninp_t wi)
{
    int   i, j, k = -1, nf;
    int   nr, nrfp;
    realA  c, bi, bj, ci, cj, ci0, ci1, ci2, cj0, cj1, cj2;
    char  errbuf[STRLEN];
...
static void push_atom_now(t_symtab *symtab, t_atoms *at, int atomnr,
                          ...
                          char *resnumberic,
                          char *resname, char *name, realA m0, realA q0,
                          int typeB, char *ctypeB, realA mB, realA qB,
                          warninp_t wi)
{
                               ...
                               int *nparam_def)
{
    ...
    if (ftype == F_PDIHS || ftype == F_RBDIHS || ftype == F_IDIHS || ftype == F_PIDIHS)
    {
         ...
         * that has the most realA matches, i.e. non-wildcard matches.
         */
...
void push_bond(directive d, t_params bondtype[], t_params bond[],
               ...
               gmx_bool bBonded, gmx_bool bGenPairs, realA fudgeQQ,
...
void convert_moltype_couple(t_molinfo *mol, int atomtype_decouple, realA fudgeQQ,
                            int couple_lam0, int couple_lam1,
