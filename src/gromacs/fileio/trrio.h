...
typedef struct gmx_trr_header_t
{
    ...
    realA        t;         /* Current time                        */
    realA        lambda;    /* Current value of lambda             */
...
gmx_bool gmx_trr_read_frame(struct t_fileio *fio, gmx_int64_t *step, realA *t, realA *lambda,
...
void gmx_trr_write_frame(struct t_fileio *fio, gmx_int64_t step, realA t, realA lambda,
