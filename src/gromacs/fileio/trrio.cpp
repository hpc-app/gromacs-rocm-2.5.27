...
static gmx_bool
do_trr_frame(t_fileio *fio, bool bRead, gmx_int64_t *step, realA *t, realA *lambda,
...
void gmx_trr_write_single_frame(const char *fn, gmx_int64_t step, realA t, realA lambda,
...
void gmx_trr_read_single_frame(const char *fn, gmx_int64_t *step, realA *t, realA *lambda,
                               rvec *box, int *natoms, rvec *x, rvec *v, rvec *f)
{
    t_fileio *fio = gmx_trr_open(fn, "r");
...
void gmx_trr_write_frame(t_fileio *fio, gmx_int64_t step, realA t, realA lambda,
                         const rvec *box, int natoms, const rvec *x, const rvec *v, const rvec *f)
{
...
gmx_bool gmx_trr_read_frame(t_fileio *fio, gmx_int64_t *step, realA *t, realA *lambda,
                            rvec *box, int *natoms, rvec *x, rvec *v, rvec *f)
{
