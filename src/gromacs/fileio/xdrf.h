...
/* Read or write a *realA* value (stored as float) */
int xdr_real(XDR *xdrs, realA *r);


/* Read or write reduced precision *realA* coordinates */
int xdr3drcoord(XDR *xdrs, realA *fp, int *size, realA *precision);
...
int xdr_xtc_seek_time(realA time, FILE *fp, XDR *xdrs, int natoms, gmx_bool bSeekForwardOnly);
