...
void xvgr_view(FILE *out, realA xmin, realA ymin, realA xmax, realA ymax,
               const gmx_output_env_t *oenv)
{
    if (output_env_get_print_xvgr_codes(oenv))
    {
...
void xvgr_world(FILE *out, realA xmin, realA ymin, realA xmax, realA ymax,
                const gmx_output_env_t *oenv)
{
    if (output_env_get_print_xvgr_codes(oenv))
    {
...
void xvgr_box(FILE *out,
              int LocType,
              realA xmin, realA ymin, realA xmax, realA ymax,
...
void write_xvg(const char *fn, const char *title, int nx, int ny, realA **y,
...
realA **read_xvg_time(const char *fn,
                     gmx_bool bHaveT, gmx_bool bTB, realA tb, gmx_bool bTE, realA te,
                     int nsets_in, int *nset, int *nval, realA *dt, realA **t)
{
    FILE      *fp;
