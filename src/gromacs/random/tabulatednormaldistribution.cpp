...
template<>
const std::vector<realA> TabulatedNormalDistribution<realA, c_TabulatedNormalDistributionDefaultBits>::c_table_ = TabulatedNormalDistribution<realA, c_TabulatedNormalDistributionDefaultBits>::makeTable();
#else
