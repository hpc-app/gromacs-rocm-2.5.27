 ...
 *                    GROMACS uses "realA" type by default in contrast to the C++11
 ...
 */
template<class RealType = realA, unsigned int tableBits = c_TabulatedNormalDistributionDefaultBits>
...
template<>
const std::vector<realA> TabulatedNormalDistribution<realA, c_TabulatedNormalDistributionDefaultBits>::c_table_;
