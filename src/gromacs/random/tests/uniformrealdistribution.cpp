 ...
 */
/*! \internal \file
 * \brief Tests for GROMACS uniform realA distribution
 *
...
TEST(UniformRealDistributionTest, GenerateCanonical)
{
    ...
    for (int i = 0; i < 10; i++)
    {
        result.push_back(gmx::generateCanonical<realA, std::numeric_limits<realA>::digits>(rng));
    }
...
TEST(UniformRealDistributionTest, Output)
{
    ...
    gmx::ThreeFry2x64<8>                    rng(123456, gmx::RandomDomain::Other);
    gmx::UniformRealDistribution<realA>      dist(1.0, 10.0);
    std::vector<realA>                       result;
...
{
    gmx::ThreeFry2x64<8>                rng(123456, gmx::RandomDomain::Other);
    gmx::UniformRealDistribution<realA>  distA(2.0, 5.0);
    gmx::UniformRealDistribution<realA>  distB(2.0, 5.0);
    gmx::UniformRealDistribution<realA>  distC(3.0, 5.0);
    gmx::UniformRealDistribution<realA>  distD(2.0, 4.0);
...
TEST(UniformRealDistributionTest, Reset)
{
    ...
    gmx::UniformRealDistribution<realA>               distA(2.0, 5.0);
    gmx::UniformRealDistribution<realA>               distB(2.0, 5.0);
    gmx::UniformRealDistribution<realA>::result_type  valA, valB;
...
TEST(UniformRealDistributionTest, AltParam)
{
    ...
    gmx::UniformRealDistribution<realA>              distA(2.0, 5.0);
    gmx::UniformRealDistribution<realA>              distB; // default parameters
    gmx::UniformRealDistribution<realA>::param_type  paramA(2.0, 5.0);
    gmx::UniformRealDistribution<realA>::result_type valA, valB;
