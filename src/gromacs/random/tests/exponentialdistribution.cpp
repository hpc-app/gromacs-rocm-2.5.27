...
TEST(ExponentialDistributionTest, Output)
{
    ...
    gmx::ExponentialDistribution<realA>  dist(5.0);
...
{
    gmx::ThreeFry2x64<8>                rng(123456, gmx::RandomDomain::Other);
    gmx::ExponentialDistribution<realA>  distA(2.0);
    gmx::ExponentialDistribution<realA>  distB(2.0);
    gmx::ExponentialDistribution<realA>  distC(3.0);
...
TEST(ExponentialDistributionTest, AltParam)
{
    ...
    gmx::ExponentialDistribution<realA>              distA(2.0);
    gmx::ExponentialDistribution<realA>              distB; // default parameters
    gmx::ExponentialDistribution<realA>::param_type  paramA(2.0);
