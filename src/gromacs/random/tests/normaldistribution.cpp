...
TEST(NormalDistributionTest, Output)
{
    ...
    gmx::NormalDistribution<realA>       dist(2.0, 5.0);
...
{
    gmx::ThreeFry2x64<8>           rng(123456, gmx::RandomDomain::Other);
    gmx::NormalDistribution<realA>  distA(2.0, 5.0);
    gmx::NormalDistribution<realA>  distB(2.0, 5.0);
    gmx::NormalDistribution<realA>  distC(3.0, 5.0);
    gmx::NormalDistribution<realA>  distD(2.0, 4.0);
...
TEST(NormalDistributionTest, Reset)
{
    ...
    gmx::NormalDistribution<realA>                       distA(2.0, 5.0);
    gmx::NormalDistribution<realA>                       distB(2.0, 5.0);
    gmx::NormalDistribution<realA>::result_type          valA, valB;
...
TEST(NormalDistributionTest, AltParam)
{
    ...
    gmx::NormalDistribution<realA>              distA(2.0, 5.0);
    gmx::NormalDistribution<realA>              distB; // default parameters
    gmx::NormalDistribution<realA>::param_type  paramA(2.0, 5.0);
    gmx::NormalDistribution<realA>::result_type valA, valB;
