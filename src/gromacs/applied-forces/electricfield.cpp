...
class ElectricFieldData
{
    public:
        ...
        {
            builder->addUniformArray<realA>("electric-field-" + name, {a_, omega_, t0_, sigma_});
        }
         ...
         */
        void setField(realA a, realA omega, realA t0, realA sigma)
        {
            a_     = a;
            omega_ = omega;
            t0_    = t0;
        ...
        realA a()     const { return a_; }
        //! Return the frequency
        realA omega() const { return omega_; }
        //! Return the time for the peak of the pulse
        realA t0()    const { return t0_; }
        //! Return the width of the pulse (0 means inifinite)
        realA sigma() const { return sigma_; }
                            ...
                            public IForceProvider
{
    ...
    private:
         ...
         */
        realA field(int dim, realA t) const;
         ...
         */
        realA a(int dim)     const { return efield_[dim].a(); }
        /*! \brief Return frequency of field (1/ps)
         *
         * \param[in] dim Direction of the field (XX, YY, ZZ)
         * \return Frequency of the field
         */
        realA omega(int dim) const { return efield_[dim].omega(); }
        /*! \brief Return time of pulse peak
         *
         * \param[in] dim Direction of the field (XX, YY, ZZ)
         * \return Time of pulse peak
         */
        realA t0(int dim) const { return efield_[dim].t0(); }
        /*! \brief Return width of the pulse
         *
         * \param[in] dim Direction of the field (XX, YY, ZZ)
         * \return Width of the pulse
         */
        realA sigma(int dim) const { return efield_[dim].sigma(); }
                       ...
                       const std::string              &value)
{
    ...
    builder->addValue<realA>("E0", fromString<realA>(sxt[0]));
    builder->addValue<realA>("omega", fromString<realA>(sxt[1]));
    builder->addValue<realA>("t0", fromString<realA>(sxt[2]));
    builder->addValue<realA>("sigma", fromString<realA>(sxt[3]));
}
...
void ElectricField::buildMdpOutput(KeyValueTreeObjectBuilder *builder) const
{
    const char *const comment[] = {
        "; Electric fields",
        "; Format for electric-field-x, etc. is: four realA variables:",
...
realA ElectricField::field(int dim, realA t) const
{
