...
static void low_rotate_conf(int natom, rvec *x, realA alfa, realA beta, realA gamma)
{
    int  i;
    rvec x_old;
...
void rotate_conf(int natom, rvec *x, rvec *v, realA alfa, realA beta, realA gamma)
{
    if (x)
    {
