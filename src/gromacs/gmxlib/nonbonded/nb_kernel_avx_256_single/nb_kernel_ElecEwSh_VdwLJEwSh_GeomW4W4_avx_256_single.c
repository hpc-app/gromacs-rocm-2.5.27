                     ...
                     t_nrnb                      * gmx_restrict        nrnb)
{
    ...
    realA             *fjptrA,*fjptrB,*fjptrC,*fjptrD,*fjptrE,*fjptrF,*fjptrG,*fjptrH;
    realA             scratch[4*DIM];
    __m256           tx,ty,tz,fscal,rcutoff,rcutoff2,jidxall;
    realA *           vdwioffsetptr0;
    realA *           vdwgridioffsetptr0;
    __m256           ix0,iy0,iz0,fix0,fiy0,fiz0,iq0,isai0;
    realA *           vdwioffsetptr1;
    realA *           vdwgridioffsetptr1;
    __m256           ix1,iy1,iz1,fix1,fiy1,fiz1,iq1,isai1;
    realA *           vdwioffsetptr2;
    realA *           vdwgridioffsetptr2;
    __m256           ix2,iy2,iz2,fix2,fiy2,fiz2,iq2,isai2;
    realA *           vdwioffsetptr3;
    realA *           vdwgridioffsetptr3;
    ...
    for(iidx=0; iidx<nri; iidx++)
    {
        ...
        if(jidx<j_index_end)
        {
            ...
            /* Sign of each element will be negative for non-realA atoms.
             * This mask will be 0xFFFFFFFF for dummy entries and 0x0 for realA ones,
