                     ...
                     t_nrnb *                  nrnb)
{
    ...
    realA                 dx, dy, dz;
    realA                 tx, ty, tz;
    realA                 rsq, rinv, rinvsq, rinvsix;
    realA                 vcoul, vctot;
    realA                 c6, c12, Vvdw6, Vvdw12, Vvdwtot;
    realA                 fscal, dvdatmp, fijC, vgb;
    realA                 Y, F, Fp, Geps, Heps2, VV, FF, eps, eps2, r, rt;
    realA                 dvdaj, gbscale, isaprod, isai, isaj, gbtabscale;
    realA           *     f;
    realA           *     x;
    t_blocka           * excl;
    realA           *     Vvdw;
