                      ...
                      t_nrnb *                  nrnb)
{
    ...
    realA          shX, shY, shZ;
    realA          fscal, felec, fvdw, velec, vvdw, tx, ty, tz;
    realA          rinvsq;
    realA          iq;
    realA          qq, vctot;
    int           nti, nvdwparam;
    int           tj;
    realA          rt, r, eps, eps2, Y, F, Geps, Heps2, VV, FF, Fp, fijD, fijR;
    realA          rinvsix;
    realA          vvdwtot;
    realA          vvdw_rep, vvdw_disp;
    realA          ix, iy, iz, fix, fiy, fiz;
    realA          jx, jy, jz;
    realA          dx, dy, dz, rsq, rinv;
    realA          c6, c12, c6grid, cexp1, cexp2, br;
    realA *        charge;
    realA *        shiftvec;
    realA *        vdwparam, *vdwgridparam;
    int *         type;
    realA *        fshift;
    realA *        velecgrp;
    realA *        vvdwgrp;
    ...
    realA *        f;
    int           ewitab;
    realA          ewtabscale, eweps, ewrt, ewtabhalfspace;
    realA *        ewtab;
    realA          rcoulomb2, rvdw, rvdw2, sh_dispersion, sh_repulsion;
    realA          rcutoff, rcutoff2;
    ...
    realA          ewclj, ewclj2, ewclj6, ewcljrsq, poly, exponent, sh_lj_ewald;
