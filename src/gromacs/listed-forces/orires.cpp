                     ...
                     t_fcdata *fcd, history_t *hist)
{
    ...
    for (int fa = 0; fa < nfa; fa += 3)
    {
        ...
        realA weight = ip[type].orires.kfac;
...
realA orires(int nfa, const t_iatom forceatoms[], const t_iparams ip[],
            ...
            int gmx_unused *global_atom_index)
{
    ...
    ivec                dt;
    realA                r2, invr, invr2, fc, smooth_fc, dev, devins, pfac;
    rvec                r, Sr, fij;
    realA                vtot;
