...
realA do_fbposres_cylinder(int fbdim, rvec fm, rvec dx, realA rfb, realA kk, gmx_bool bInvert)
{
    int     d;
    realA    dr, dr2, invdr, v, rfb2;
