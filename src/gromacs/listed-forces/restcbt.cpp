...
void compute_factors_restangles(int type, const t_iparams forceparams[],
                                ...
                                realA *prefactor, realA *ratio_ante, realA *ratio_post, realA *v)
{
    realA theta_equil, k_bending;
    realA cosine_theta_equil;
    realA c_ante, c_cros, c_post;
    realA norm;
    realA delta_cosine, cosine_theta;
    realA sine_theta_sq;
    realA term_theta_theta_equil;
...
void compute_factors_restrdihs(int type,  const t_iparams forceparams[],
                               ...
                               realA *factor_phi_ai_ante, realA *factor_phi_ai_crnt, realA *factor_phi_ai_post,
                               realA *factor_phi_aj_ante, realA *factor_phi_aj_crnt, realA *factor_phi_aj_post,
                               realA *factor_phi_ak_ante, realA *factor_phi_ak_crnt, realA *factor_phi_ak_post,
                               realA *factor_phi_al_ante, realA *factor_phi_al_crnt, realA *factor_phi_al_post,
                               realA *prefactor_phi, realA *v)
{

    realA phi0, cosine_phi0;
    realA k_torsion;
    realA c_self_ante, c_self_crnt, c_self_post;
    realA c_cros_ante, c_cros_acrs, c_cros_post;
    realA c_prod, d_post, d_ante;
    realA sine_phi_sq, cosine_phi;
    realA delta_cosine, term_phi_phi0;
    realA ratio_phi_ante, ratio_phi_post;
    realA norm_phi;
...
{
    int  j, d;
    realA torsion_coef[NR_CBTDIHS];
    realA c_self_ante, c_self_crnt, c_self_post;
    realA c_cros_ante, c_cros_acrs, c_cros_post;
    realA c_prod, d_ante,  d_post;
    realA norm_phi, norm_theta_ante, norm_theta_post;
    realA cosine_phi, cosine_theta_ante, cosine_theta_post;
    realA sine_theta_ante_sq, sine_theta_post_sq;
    realA sine_theta_ante, sine_theta_post;
    realA prefactor_phi;
    realA ratio_phi_ante, ratio_phi_post;
    realA r1, r2;
    ...
    realA prefactor_theta_ante, ratio_theta_ante_ante, ratio_theta_ante_crnt;
    realA prefactor_theta_post, ratio_theta_post_crnt, ratio_theta_post_post;
