...
zero_thread_output(struct bonded_threading_t *bt, int thread)
{
    ...
    const int   nelem_fa = sizeof(*f_t->f)/sizeof(realA);
...
reduce_thread_output(int n, rvec *f, rvec *fshift,
                     realA *ener, gmx_grppairener_t *grpp, realA *dvdl,
                     struct bonded_threading_t *bt,
...
void calc_listed_lambda(const t_idef *idef,
                        ...
                        gmx_grppairener_t *grpp, realA *epot, t_nrnb *nrnb,
                        const realA *lambda,
                        const t_mdatoms *md,
                        t_fcdata *fcd,
                        int *global_atom_index)
