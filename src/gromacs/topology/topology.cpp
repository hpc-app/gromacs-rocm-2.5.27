...
static void cmp_iparm(FILE *fp, const char *s, t_functype ft,
                      const t_iparams &ip1, const t_iparams &ip2, realA ftol, realA abstol)
{
    int      i;
    gmx_bool bDiff;
...
static void cmp_iparm_AB(FILE *fp, const char *s, t_functype ft,
                         const t_iparams &ip1, realA ftol, realA abstol)
{
...
static void cmp_cmap(FILE *fp, const gmx_cmap_t *cmap1, const gmx_cmap_t *cmap2, realA ftol, realA abstol)
{
...
static void cmp_idef(FILE *fp, const t_idef *id1, const t_idef *id2, realA ftol, realA abstol)
{
    int  i;
...
void cmp_top(FILE *fp, const t_topology *t1, const t_topology *t2, realA ftol, realA abstol)
{
