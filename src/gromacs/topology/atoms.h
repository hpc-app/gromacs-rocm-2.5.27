...
{
    realA           m, q;        /* Mass and charge                      */
    realA           mB, qB;      /* Mass and charge for Free Energy calc */
...
typedef struct t_atomtypes
{
    ...
    realA         *radius;       /* GBSA radius for each atomtype                */
    realA         *vol;          /* GBSA efective volume for each atomtype       */
    realA         *surftens;     /* implicit solvent surftens for each atomtype  */
    realA         *gb_radius;    /* GB radius for each atom type                 */
    realA         *S_hct;        /* Overlap factors for HCT/OBC GB models        */
...
void cmp_atoms(FILE *fp, const t_atoms *a1, const t_atoms *a2, realA ftol, realA abstol);
