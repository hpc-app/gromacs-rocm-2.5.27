...
typedef union t_iparams
{
    ...
    struct {
        realA klinA, aA, klinB, aB;
    } linangle;
    struct {
        realA lowA, up1A, up2A, kA, lowB, up1B, up2B, kB;
    } restraint;
    ...
    struct {
        realA r1e, r2e, r3e, krt;
    } cross_ba;
    struct {
        realA thetaA, kthetaA, r13A, kUBA, thetaB, kthetaB, r13B, kUBB;
    } u_b;
    struct {
        realA theta, c[5];
    } qangle;
    ...
    struct {
        realA alpha, drcut, khyp;
    } anharm_polarize;
    struct {
        realA al_x, al_y, al_z, rOH, rHH, rOD;
    } wpol;
    struct {
        realA a, alpha1, alpha2, rfac;
    } thole;
    struct {
        realA c6, c12;
    } lj;
    struct {
        realA c6A, c12A, c6B, c12B;
    } lj14;
    struct {
        realA fqq, qi, qj, c6, c12;
    } ljc14;
    struct {
        realA qi, qj, c6, c12;
    } ljcnb;
     ...
     */
    struct {
        realA phiA, cpA; int mult; realA phiB, cpB;
    } pdihs;
    struct {
        realA dA, dB;
    } constr;
    ...
    struct {
        realA b0A, cbA, betaA, b0B, cbB, betaB;
    } morse;
    struct {
        realA pos0A[DIM], fcA[DIM], pos0B[DIM], fcB[DIM];
    } posres;
    struct {
        realA pos0[DIM], r, k; int geom;
    } fbposres;
    struct {
        realA rbcA[NR_RBDIHS], rbcB[NR_RBDIHS];
    } rbdihs;
    struct {
        realA cbtcA[NR_CBTDIHS], cbtcB[NR_CBTDIHS];
    } cbtdihs;
    struct {
        realA a, b, c, d, e, f;
    } vsite;
    ...
    struct {
        realA low, up1, up2, kfac; int type, label, npair;
    } disres;
    struct {
        realA phiA, dphiA, kfacA, phiB, dphiB, kfacB;
    } dihres;
    struct {
        int  ex, power, label; realA c, obs, kfac;
    } orires;
    struct {
        int  table; realA kA; realA kB;
    } tab;
    struct {
        realA sar, st, pi, gbr, bmlt;
    } gb;
    struct {
        int cmapA, cmapB;
    } cmap;
    struct {
        realA buf[MAXFORCEPARAM];
    } generic;                                               /* Conversion */
} t_iparams;
...
typedef struct
{
    realA *cmap; /* Has length 4*grid_spacing*grid_spacing, */
...
typedef struct gmx_ffparams_t
{
    ...
    realA        fudgeQQ;   /* The scaling factor for Coulomb 1-4: f*q1*q2  */
