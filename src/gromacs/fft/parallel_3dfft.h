 ...
 *
 *  This routine performs realA-to-complex and complex-to-realA parallel 3D FFTs,
 ...
 *  \param realGridAllocation  Whether to make realA grid use allocation pinned for GPU transfers.
