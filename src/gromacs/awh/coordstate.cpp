                              ...
                              gmx_int64_t            indexSeed1)
{
    ...
    gmx::UniformRealDistribution<realA> uniformRealDistr;
    ...
    /* Use binary search to convert the realA value to an integer in [0, ndistr - 1] distributed according to distr. */
