 ...
 */
typedef realA vec4[4];

/*! \brief
 * 4D matrix type used in 3D transformations.
 */
typedef realA mat4[4][4];
...
void gmx_mat4_init_rotation(int axis, realA angle, mat4 A);

void gmx_mat4_init_translation(realA tx, realA ty, realA tz, mat4 A);
