...
{
    matrix in = {{1, 2, 3}, {-1, realA(2.5), 1}, {10, -2, realA(1.2)}};
    matrix out;
    matrix expected = {{realA(-0.12019230769230768),
                        realA(0.20192307692307693),
                        realA(0.13221153846153844)},
                       {realA(-0.26923076923076916),
                        realA(0.69230769230769229),
                        realA(0.096153846153846145)},
                       {realA(0.55288461538461531),
                        realA(-0.52884615384615374),
                        realA(-0.10817307692307691)}};
...
{
    matrix in       = {{1, 0, 0}, {-1, realA(2.5), 0}, {10, -2, realA(1.2)}};
    matrix expected = {{1, 0, 0},
                       {realA(0.4), realA(0.4), 0},
                       {realA(-23.0/3.0), realA(2.0/3.0), realA(5.0/6.0)}};
