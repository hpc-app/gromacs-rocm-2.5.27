...
class SurfaceAreaTest : public ::testing::Test
{
    public:
        ...
        void addSphere(realA x, realA y, realA z, realA radius,
        ...
        void generateRandomPosition(rvec x, realA *radius)
        {
            rvec fx;
        ...
        void translatePoints(realA x, realA y, realA z)
        {
        ...
        realA resultArea() const { return area_; }
        realA resultVolume() const { return volume_; }
        realA atomArea(int index) const { return atomArea_[index]; }
    ...
    private:
        static int dotComparer(const void *a, const void *b)
        {
            ...
            {
                const realA ad = reinterpret_cast<const realA *>(a)[d];
                const realA bd = reinterpret_cast<const realA *>(b)[d];
...
TEST_F(SurfaceAreaTest, ComputesTwoPointsOfUnequalRadius)
{
    ...
    const realA dist = 0.5 + sqrt(3.25);
