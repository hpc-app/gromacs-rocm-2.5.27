 ...
 *
 * This function mimicks the SIMD integer-to-realA conversion routines. By
...
/*! \brief Just return a boolean (mimicks SIMD realA-to-int bool conversions)
 *
 * \param a  boolean
 * \return same boolean
 *
...
/*! \brief Just return a boolean (mimicks SIMD int-to-realA bool conversions)
 *
 * \param a  boolean
 * \return same boolean
 *
