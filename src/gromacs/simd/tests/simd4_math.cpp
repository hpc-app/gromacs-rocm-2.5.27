    ...
    public:
        ::testing::AssertionResult
                             compareSimd4MathFunction(const char * refFuncExpr, const char *simd4FuncExpr,
                                                      realA refFunc(realA x),     Simd4Real gmx_simdcall simd4Func(Simd4Real x));
};
...
Simd4MathTest::compareSimd4MathFunction(const char * refFuncExpr, const char *simd4FuncExpr,
                                        realA refFunc(realA x),     Simd4Real gmx_simdcall simd4Func(Simd4Real x))
{
    std::vector<realA>            vx(GMX_SIMD4_WIDTH);
    std::vector<realA>            vref(GMX_SIMD4_WIDTH);
    std::vector<realA>            vtst(GMX_SIMD4_WIDTH);
    realA                         dx;
