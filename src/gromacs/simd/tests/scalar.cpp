...
{
    realA signBit = GMX_REAL_NEGZERO;
...
{
    EXPECT_EQ(c1*c2+c3, fma(realA(c1), realA(c2), realA(c3)));
}
...
{
    EXPECT_EQ(realA(2), round(realA(2.25)));
    EXPECT_EQ(realA(4), round(realA(3.75)));
    EXPECT_EQ(realA(-2), round(realA(-2.25)));
    EXPECT_EQ(realA(-4), round(realA(-3.75)));
}
...
{
    EXPECT_EQ(realA(2), trunc(realA(2.25)));
    EXPECT_EQ(realA(3), trunc(realA(3.75)));
    EXPECT_EQ(realA(-2), trunc(realA(-2.25)));
    EXPECT_EQ(realA(-3), trunc(realA(-3.75)));
}
