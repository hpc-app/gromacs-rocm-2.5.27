...
{
    public:
        /*! \brief Compare two realA SIMD4 variables for approximate equality.
         *
        ...
        /*! \brief Compare two realA SIMD4 variables for exact equality.
         *
         * This is an internal implementation routine. YOu should always use
         * GMX_EXPECT_SIMD4_REAL_NEAR() instead.
         *
...
/*! \brief Convert SIMD4 realA to std::vector<realA>.
 *
 * The returned vector will have the same length as the SIMD4 width.
 */
std::vector<realA> simd4Real2Vector(const Simd4Real simd4);

/*! \brief Return floating-point SIMD4 value from std::vector<realA>.
 *
 ...
 */
Simd4Real   vector2Simd4Real(const std::vector<realA> &v);

/*! \brief Set SIMD4 register contents from three realA values.
 *
 ...
 */
Simd4Real   setSimd4RealFrom3R(realA r0, realA r1, realA r2);

/*! \brief Set SIMD4 register contents from single realA value.
 *
 ...
 */
Simd4Real   setSimd4RealFrom1R(realA value);

/*! \brief Test if a SIMD4 realA is bitwise identical to reference SIMD4 value. */
#define GMX_EXPECT_SIMD4_REAL_EQ(ref, tst)   EXPECT_PRED_FORMAT2(compareSimd4RealEq, ref, tst)

/*! \brief Test if a SIMD4 realA is within tolerance of reference SIMD4 value. */
