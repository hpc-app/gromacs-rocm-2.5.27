...
int gmx_stats_get_point(gmx_stats_t gstats, realA *x, realA *y,
                        realA *dx, realA *dy, realA level)
{
    gmx_stats *stats = gstats;
    int        ok, outlier;
    realA       rmsd, r;
...
int gmx_stats_add_points(gmx_stats_t gstats, int n, realA *x, realA *y,
                         realA *dx, realA *dy)
{
    for (int i = 0; (i < n); i++)
    {
...
int gmx_stats_get_ab(gmx_stats_t gstats, int weight,
                     realA *a, realA *b, realA *da, realA *db,
                     realA *chi2, realA *Rfit)
{
    gmx_stats *stats = gstats;
    int        ok;
...
int gmx_stats_get_a(gmx_stats_t gstats, int weight, realA *a, realA *da,
                    realA *chi2, realA *Rfit)
{
    gmx_stats *stats = gstats;
    int        ok;
...
int gmx_stats_get_average(gmx_stats_t gstats, realA *aver)
{
    gmx_stats *stats = gstats;
    int        ok;
...
int gmx_stats_get_ase(gmx_stats_t gstats, realA *aver, realA *sigma, realA *error)
{
    gmx_stats *stats = gstats;
    int        ok;
...
int gmx_stats_get_sigma(gmx_stats_t gstats, realA *sigma)
{
    gmx_stats *stats = gstats;
    int        ok;
...
int gmx_stats_get_error(gmx_stats_t gstats, realA *error)
{
    gmx_stats *stats = gstats;
    int        ok;
...
int gmx_stats_get_corr_coeff(gmx_stats_t gstats, realA *R)
{
    gmx_stats *stats = gstats;
    int        ok;
...
int gmx_stats_get_rmsd(gmx_stats_t gstats, realA *rmsd)
{
    gmx_stats *stats = gstats;
    int        ok;
...
int gmx_stats_make_histogram(gmx_stats_t gstats, realA binwidth, int *nb,
                             int ehisto, int normalized, realA **x, realA **y)
{
    gmx_stats *stats = gstats;
...
/* Old convenience functions, should be merged with the core
   statistics above. */
int lsq_y_ax(int n, realA x[], realA y[], realA *a)
{
...
static int low_lsq_y_ax_b(int n, realA *xr, double *xd, realA yr[],
                          realA *a, realA *b, realA *r, realA *chi2)
{
    gmx_stats_t lsq = gmx_stats_init();
    int         ok;
...
int lsq_y_ax_b(int n, realA x[], realA y[], realA *a, realA *b, realA *r, realA *chi2)
{
    return low_lsq_y_ax_b(n, x, nullptr, y, a, b, r, chi2);
}

int lsq_y_ax_b_xdouble(int n, double x[], realA y[], realA *a, realA *b,
                       realA *r, realA *chi2)
{
    return low_lsq_y_ax_b(n, nullptr, x, y, a, b, r, chi2);
}

int lsq_y_ax_b_error(int n, realA x[], realA y[], realA dy[],
                     realA *a, realA *b, realA *da, realA *db,
                     realA *r, realA *chi2)
{
    gmx_stats_t lsq = gmx_stats_init();
