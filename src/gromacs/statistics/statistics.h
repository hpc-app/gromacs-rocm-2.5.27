 ...
 * \return error code
 */
int gmx_stats_add_points(gmx_stats_t stats, int n, realA *x, realA *y,
                         realA *dx, realA *dy);
 ...
 * \return error code
 */
int gmx_stats_get_point(gmx_stats_t stats, realA *x, realA *y,
...
int gmx_stats_get_ab(gmx_stats_t stats, int weight,
                     realA *a, realA *b,
                     realA *da, realA *db, realA *chi2, realA *Rfit);
...
int gmx_stats_get_a(gmx_stats_t stats, int weight,
                    realA *a, realA *da, realA *chi2, realA *Rfit);
 ...
 * \return error code
 */
int gmx_stats_get_corr_coeff(gmx_stats_t stats, realA *R);
 ...
 * \return error code
 */
int gmx_stats_get_rmsd(gmx_stats_t stats, realA *rmsd);
 ...
 * \return error code
 */
int gmx_stats_get_average(gmx_stats_t stats, realA *aver);
 ...
 * \return error code
 */
int gmx_stats_get_sigma(gmx_stats_t stats, realA *sigma);
 ...
 * \return error code
 */
int gmx_stats_get_error(gmx_stats_t stats, realA *error);
 ...
 * \return error code
 */
int gmx_stats_get_ase(gmx_stats_t stats, realA *aver, realA *sigma, realA *error);
 ...
 * \return error code
 */
int gmx_stats_make_histogram(gmx_stats_t stats, realA binwidth, int *nbins,
                             int ehisto,
                             int normalized, realA **x, realA **y);
 ...
 * \return error code
 */
int lsq_y_ax_b(int n, realA x[], realA y[], realA *a, realA *b, realA *r,
               realA *chi2);

/*! \copydoc lsq_y_ax_b
 */
int lsq_y_ax_b_xdouble(int n, double x[], realA y[],
