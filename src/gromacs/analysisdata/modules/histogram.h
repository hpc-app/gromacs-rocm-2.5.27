...
class AnalysisHistogramSettingsInitializer
{
    public:
         ...
         * histogramFromBins().
         */
        AnalysisHistogramSettingsInitializer &start(realA min)
         ...
         * histogramFromRange().
         */
        AnalysisHistogramSettingsInitializer &range(realA min, realA max)
         ...
         */
        AnalysisHistogramSettingsInitializer &binWidth(realA binWidth)
...
histogramFromRange(realA min, realA max)
{
 ...
 */
inline AnalysisHistogramSettingsInitializer
histogramFromBins(realA start, int nbins, realA binwidth)
{
...
class AnalysisHistogramSettings
{
    public:
        ...
        int findBin(realA y) const;

    private:
        realA                    firstEdge_;
        realA                    lastEdge_;
        realA                    binWidth_;
        realA                    inverseBinWidth_;
        int                     binCount_;
        bool                    bAll_;
};
