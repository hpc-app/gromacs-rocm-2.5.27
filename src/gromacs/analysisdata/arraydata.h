...
class AbstractAnalysisArrayData : public AbstractAnalysisData
{
    public:
        ...
        realA xstart() const { return xvalue_[0]; }
    ...
    protected:
         ...
         * Does not throw.
         */
        void setXAxis(realA start, realA step);
        /*! \brief
         ...
         * Does not throw.
         */
        void setXAxisValue(int row, realA value);
