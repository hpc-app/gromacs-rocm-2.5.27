...
class AnalysisDataTestInputPointSet
{
    public:
        ...
        realA y(int i) const { return values_[i].y; }
        ...
        realA error(int i) const { return values_[i].error; }
        ...
        void addValue(realA y) { values_.emplace_back(y); }
        //! Appends a value with an error estimate to this point set.
        void addValueWithError(realA y, realA error)
        {
    ...
    private:
        ...
        struct Value
        {
            ...
            explicit Value(realA y) : y(y), error(0.0), bError(false) {}
            Value(realA y, realA error) : y(y), error(error), bError(true) {}
...
class AnalysisDataTestInputFrame
{
    public:
        ...
        realA x() const { return x_; }
        //! Returns error in the x coordinate for the frame.
        realA dx() const { return 0.0; }
        ...
        void addPointSetWithValues(int dataSet, int firstColumn, realA y1);
        //! Adds a point set with given values to this frame.
        void addPointSetWithValues(int dataSet, int firstColumn,
                                   realA y1, realA y2);
        //! Adds a point set with given values to this frame.
        void addPointSetWithValues(int dataSet, int firstColumn,
                                   realA y1, realA y2, realA y3);
        //! Adds a point set with given values to this frame.
    ...
    private:
        ...
        AnalysisDataTestInputFrame(int index, realA x);
...
class AnalysisDataTestInput
{
    public:
        ...
        AnalysisDataTestInputFrame &addFrame(realA x);
        //! Adds a frame with a single point set and the given values.
        void addFrameWithValues(realA x, realA y1);
        //! Adds a frame with a single point set and the given values.
        void addFrameWithValues(realA x, realA y1, realA y2);
        //! Adds a frame with a single point set and the given values.
        void addFrameWithValues(realA x, realA y1, realA y2, realA y3);
        //! Adds a frame with a single point set and the given values.
        void addFrameWithValueAndError(realA x, realA y1, realA e1);
