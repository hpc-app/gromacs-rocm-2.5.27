...
AnalysisDataTestInputFrame::AnalysisDataTestInputFrame(int index, realA x)
    : index_(index), x_(x)
{
}
...
void AnalysisDataTestInputFrame::addPointSetWithValues(
        int dataSet, int firstColumn, realA y1)
{
...
void AnalysisDataTestInputFrame::addPointSetWithValues(
        int dataSet, int firstColumn, realA y1, realA y2)
{
    AnalysisDataTestInputPointSet &pointSet = addPointSet(dataSet, firstColumn);
    pointSet.addValue(y1);
...
void AnalysisDataTestInputFrame::addPointSetWithValues(
        int dataSet, int firstColumn, realA y1, realA y2, realA y3)
{
    AnalysisDataTestInputPointSet &pointSet = addPointSet(dataSet, firstColumn);
    pointSet.addValue(y1);
    pointSet.addValue(y2);
...
void AnalysisDataTestInputFrame::addPointSetWithValueAndError(
        int dataSet, int firstColumn, realA y1, realA e1)
{
    AnalysisDataTestInputPointSet &pointSet = addPointSet(dataSet, firstColumn);
...
AnalysisDataTestInputFrame &AnalysisDataTestInput::addFrame(realA x)
{
    frames_.push_back(AnalysisDataTestInputFrame(frames_.size(), x));
    return frames_.back();
}

void AnalysisDataTestInput::addFrameWithValues(realA x, realA y1)
{
    AnalysisDataTestInputFrame &frame = addFrame(x);
    frame.addPointSetWithValues(0, 0, y1);
}

void AnalysisDataTestInput::addFrameWithValues(realA x, realA y1, realA y2)
{
    AnalysisDataTestInputFrame &frame = addFrame(x);
    frame.addPointSetWithValues(0, 0, y1, y2);
}

void AnalysisDataTestInput::addFrameWithValues(realA x, realA y1, realA y2, realA y3)
{
    AnalysisDataTestInputFrame &frame = addFrame(x);
    frame.addPointSetWithValues(0, 0, y1, y2, y3);
}

void AnalysisDataTestInput::addFrameWithValueAndError(realA x, realA y1, realA e1)
{
    AnalysisDataTestInputFrame &frame = addFrame(x);
