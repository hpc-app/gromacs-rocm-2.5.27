...
class AnalysisDataStorageFrame
{
    public:
         ...
         * Does not throw.
         */
        void setValue(int column, realA value, bool bPresent = true)
        {
         ...
         * Does not throw.
         */
        void setValue(int column, realA value, realA error, bool bPresent = true)
        {
            GMX_ASSERT(column >= 0 && column < columnCount(),
                       "Invalid column index");
...
class AnalysisDataStorage
{
    public:
         ...
         */
        AnalysisDataStorageFrame &startFrame(int index, realA x, realA dx);
        /*! \brief
