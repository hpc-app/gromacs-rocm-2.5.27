...
class AnalysisDataValue
{
    public:
         ...
         */
        explicit AnalysisDataValue(realA value)
        ...
        //! Sets this value.
        void setValue(realA value, bool bPresent = true)
        {
            value_ = value;
            flags_.set(efSet);
        ...
        void setValue(realA value, realA error, bool bPresent = true)
        {
            value_ = value;
            error_ = error;
            flags_.set(efSet);
...
class AnalysisDataFrameHeader
{
    public:
         ...
         */
        AnalysisDataFrameHeader(int index, realA x, realA dx);
