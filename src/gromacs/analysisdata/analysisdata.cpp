...
void
AnalysisDataHandle::startFrame(int index, realA x, realA dx)
{
...
void
AnalysisDataHandle::setPoint(int column, realA value, bool bPresent)
{
    GMX_RELEASE_ASSERT(impl_ != nullptr, "Invalid data handle used");
    GMX_RELEASE_ASSERT(impl_->currentFrame_ != nullptr,
...
void
AnalysisDataHandle::setPoint(int column, realA value, realA error, bool bPresent)
{
    GMX_RELEASE_ASSERT(impl_ != nullptr, "Invalid data handle used");
    GMX_RELEASE_ASSERT(impl_->currentFrame_ != nullptr,
                       "setPoint() called without calling startFrame()");
...
void
AnalysisDataHandle::setPoints(int firstColumn, int count, const realA *values,
                              bool bPresent)
{
    GMX_RELEASE_ASSERT(impl_ != nullptr, "Invalid data handle used");
    GMX_RELEASE_ASSERT(impl_->currentFrame_ != nullptr,
