...
class AnalysisDataHandle
{
    public:
         ...
         * is not finished).
         */
        void startFrame(int index, realA x, realA dx = 0.0);
        /*! \brief
         ...
         * Does not throw.
         */
        void setPoint(int column, realA value, bool bPresent = true);
        /*! \brief
         ...
         * Does not throw.
         */
        void setPoint(int column, realA value, realA error, bool bPresent = true);
        /*! \brief
         ...
         * Does not throw.
         */
        void setPoints(int firstColumn, int count, const realA *values, bool bPresent = true);
        /*! \brief
