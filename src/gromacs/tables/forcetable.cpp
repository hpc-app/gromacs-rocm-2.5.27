...
static void copy2table(int n, int offset, int stride,
                       double x[], double Vtab[], double Ftab[], realA scalefactor,
                       realA dest[])
{
                          ...
                          realA rtab, int flags)
{
     ...
     */
    snew_aligned(table->data, table->stride*(table->n+1)*sizeof(realA), 32);
