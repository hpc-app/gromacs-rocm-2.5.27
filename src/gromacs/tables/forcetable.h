 ...
 * \param v_lr       Pointer to function calculating realA-space grid contribution
 */
void table_spline3_fill_ewald_lr(realA                                 *table_F,
                                 realA                                 *table_V,
                                 realA                                 *table_FDV0,
                                 int                                   ntab,
                                 double                                dx,
 ...
 */
realA ewald_spline3_table_scale(const interaction_const_t *ic);

/*! \brief Return the realA space grid contribution for Ewald
 *
 *  \param beta  Ewald splitting parameter
 *  \param r     Distance for which to calculate the realA-space contrib
 *  \return      Real space grid contribution for Ewald electrostatics
 */
double v_q_ewald_lr(double beta, double r);

/*! \brief Return the realA space grid contribution for LJ-Ewald
 *
 *  \param beta  Ewald splitting parameter
 *  \param r     Distance for which to calculate the realA-space contrib
...
t_forcetable *make_tables(FILE *fp,
                          ...
                          const char *fn, realA rtab, int flags);
