 ...
 *       show up in any realA cases, and for this reason we choose not to do
...
class QuadraticSplineTable
{
    private:
         ...
         *
         *  \tparam T   Lookup argument floating-point type, typically SimdReal or realA.
    ...
    public:
         ...
         */
        static const realA defaultTolerance;
        ...
        QuadraticSplineTable(std::initializer_list<AnalyticalSplineTableInput>   analyticalInputList,
                             const std::pair<realA, realA>                        &range,
                             realA                                                tolerance = defaultTolerance);
         ...
         *
         *  This is a templated method where the template can be either realA or SimdReal.
         *
         ...
         *  \tparam     T               Type (SimdReal or realA) of lookup and result
    ...
    private:
        ...
        std::pair<realA, realA>   range_;          //!< Range for which table evaluation is allowed
        realA                    tableScale_;     //!< Table scale (inverse of spacing between points)
        realA                    halfSpacing_;    //!< 0.5*spacing (used for DDFZ table data)

        //!< Derivative values only, with the third-derivative subtraction described in the class documentation.
        std::vector<realA>      derivativeMultiTableData_;
         ...
         */
        std::vector<realA, AlignedAllocator<realA> >  ddfzMultiTableData_;
