...
fillSingleQuadraticSplineTableData(const std::function<double(double)>   &function,
                                   ...
                                   double                                 spacing,
                                   std::vector<realA>                     *functionTableData,
                                   std::vector<realA>                     *derivativeTableData)
{
 ...
 */
void
fillDdfzTableData(const std::vector<realA>    &functionTableData,
                  const std::vector<realA>    &derivativeTableData,
                  std::vector<realA>          *ddfzTableData)
{
    ...
    : numFuncInTable_(analyticalInputList.size()), range_(range)
{
    ...
    for (auto thisFuncInput : analyticalInputList)
    {
        try
        {
            std::vector<realA> tmpFuncTableData;
            std::vector<realA> tmpDerTableData;
            std::vector<realA> tmpDdfzTableData;
