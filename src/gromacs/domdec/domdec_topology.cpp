...
static realA dd_dist2(t_pbc *pbc_null, rvec *cg_cm, const int *la2lc, int i, int j)
{
    rvec dx;
...
static void update_max_bonded_distance(realA r2, int ftype, int a1, int a2,
                ...
                for (int i = 0; i < il->nr; i += 1+nral)
                {
                    for (int ai = 0; ai < nral; ai++)
                    {
                        ...
                        for (int aj = ai + 1; aj < nral; aj++)
                        {
                            ...
                            if (cgi != cgj)
                            {
                                realA rij2 = distance2(cg_cm[cgi], cg_cm[cgj]);
