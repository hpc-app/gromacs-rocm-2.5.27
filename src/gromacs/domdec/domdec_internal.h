...
typedef struct
{
    ...
    realA     *cell_f;      /**< State var.: cell boundaries, box relative     */
    realA     *old_cell_f;  /**< Temp. var.: old cell size                     */
    realA     *cell_f_max0; /**< State var.: max lower bound., incl. neighbors */
    realA     *cell_f_min1; /**< State var.: min upper bound., incl. neighbors */
    realA     *bound_min;   /**< Temp. var.: lower limit for cell boundary     */
    realA     *bound_max;   /**< Temp. var.: upper limit for cell boundary     */
    gmx_bool  bLimited;    /**< State var.: is DLB limited in this row        */
    realA     *buf_ncd;     /**< Temp. var.                                    */
} domdec_root_t;
...
typedef struct
{
    ...
    realA    *slb_dim_f; /**< Cell sizes for determining the PME comm. with SLB */
...
typedef struct
{
    realA min0;    /* The minimum bottom of this zone                        */
    realA max1;    /* The maximum top of this zone                           */
    realA min1;    /* The minimum top of this zone                           */
    realA mch0;    /* The maximum bottom communicaton height for this zone   */
    realA mch1;    /* The maximum top communicaton height for this zone      */
    realA p1_0;    /* The bottom value of the first cell in this zone        */
    realA p1_1;    /* The top value of the first cell in this zone           */
} gmx_ddzone_t;
...
struct gmx_domdec_comm_t
{
    ...
    realA     cutoff_mbody;        /**< Cut-off for multi-body interactions, also 2-body bonded when \p cutoff_mody > \p cutoff */
    realA     cutoff;              /**< Cut-off for non-bonded/2-body interactions */
    ...
    realA     cellsize_limit;      /**< The lower limit for the DD cell size with DLB */
    ...
    realA           *cell_f_row;        /**< The cell sizes, in fractions, along a row */
    realA            cell_f0[DIM];      /**< The lower corner, in fractions, in triclinic space */
    realA            cell_f1[DIM];      /**< The upper corner, in fractions, in triclinic space */
    realA            cell_f_max0[DIM];  /**< The maximum lower corner among all our neighbors */
    realA            cell_f_min1[DIM];  /**< The minimum upper corner among all our neighbors */
