...
class SelectionParserValue
{
    public:
         ...
         */
        static SelectionParserValue
        createReal(realA value, const SelectionLocation &location)
        {
         ...
         */
        static SelectionParserValue
        createRealRange(realA from, realA to, const SelectionLocation &location)
        {
            SelectionParserValue result(REAL_VALUE, location);
            result.u.r.r1 = from;
            result.u.r.r2 = to;
        ...
        union {
            ...
            //! The realA value/range (\a type ::REAL_VALUE).
            struct {
                //! Beginning of the range.
                realA            r1;
...
gmx::SelectionTreeElementPointer
_gmx_sel_init_const_position(realA x, realA y, realA z, void *scanner);
