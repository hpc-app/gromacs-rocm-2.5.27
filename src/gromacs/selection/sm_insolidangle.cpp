...
static int
find_partition_bin(t_partition *p, realA value);
...
update_surface_bin(t_methoddata_insolidangle *surf, int tbin,
                   realA phi, realA pdelta1, realA pdelta2, realA pdeltamax,
                   rvec x);
...
{
    realA theta, phi;
    realA pdeltamax, tmax;
    realA theta1, theta2, pdelta1, pdelta2;
    int  tbin;
