...
class AnalysisNeighborhoodPair
{
    public:
        ...
        AnalysisNeighborhoodPair(int refIndex, int testIndex, realA distance2,
                                 const rvec dx)
...
class AnalysisNeighborhoodSearch
{
    public:
         ...
         *     cutoff.
         */
        realA minimumDistance(const AnalysisNeighborhoodPositions &positions) const;
        /*! \brief
