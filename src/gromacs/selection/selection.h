...
class SelectionData
{
    ...
    private:
        ...
        std::vector<realA>         posMass_;
        //! Total charges for the current positions.
        std::vector<realA>         posCharge_;
        ...
        realA                      coveredFraction_;
        //! The average covered fraction (over the trajectory).
        realA                      averageCoveredFraction_;
...
class Selection
{
    public:
        ...
        ArrayRef<const realA> masses() const
        {
        ...
        ArrayRef<const realA> charges() const
        {
        ...
        realA coveredFraction() const { return data().coveredFraction_; }
