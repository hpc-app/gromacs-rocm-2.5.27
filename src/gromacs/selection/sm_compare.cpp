    ...
    for (i = 0; i < n; ++i)
    {
        switch (cmpt)
        {
            ...
            case CMP_NEQ:
                 ...
                 * proper preparations. */
                GMX_THROW(gmx::NotImplementedError("Equality comparison between dynamic integer and static realA expressions not implemented"));
 ...
 * \param[in]  data  Should point to a \c t_methoddata_compare.
 *
 * Left value is assumed to be realA-valued; right value can be either.
