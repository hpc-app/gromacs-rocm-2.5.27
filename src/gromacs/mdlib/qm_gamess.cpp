...
void
    F77_FUNC(grads, GRADS) (int *nrqmat, realA *qmcrd, int *nrmmat, realA *mmchrg,
                            realA *mmcrd, realA *qmgrad, realA *mmgrad, realA *energy);
...
realA call_gamess(t_forcerec *fr, t_QMrec *qm, t_MMrec *mm,
                 rvec f[], rvec fshift[])
{
