...
typedef struct gmx_constr {
    ...
    realA              *lagr;           /* -2 times the Lagrange multipliers for SHAKE */
                   ...
                   t_nrnb *nrnb, int econq)
{
    ...
    int         start, homenr;
    tensor      vir_r_m_dr;
    realA        scaled_delta_t;
    realA        invdt, vir_fac = 0, t;
    t_ilist    *settle;
    int         nsettle;
    t_pbc       pbc, *pbc_null;
    char        buf[22];
...
realA *constr_rmsd_data(struct gmx_constr *constr)
{
    if (constr->lincsd)
    {
...
realA constr_rmsd(struct gmx_constr *constr)
{
    if (constr->lincsd)
    {
...
static realA constr_r_max_moltype(const gmx_moltype_t *molt,
                                 ...
                                 const t_inputrec    *ir)
{
    ...
    t_blocka at2con;
    realA     r0, r1, r2maxA, r2maxB, rmax, lam0, lam1;
