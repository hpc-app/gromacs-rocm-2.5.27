 ...
 */
static const realA verlet_buffer_ratio_nodynamics = 0.05;
static const realA verlet_buffer_ratio_NVE_T0     = 0.10;
...
struct atom_nonbonded_kinetic_prop_t
{
    ...
    realA     con_mass; /* mass of heaviest atom connected by constraints */
    realA     con_len;  /* constraint length to the heaviest atom */
};
