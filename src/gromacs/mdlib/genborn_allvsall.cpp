                                  ...
                                  void *                 work)
{
    ...
    realA                    gpi, rai, vai;
    realA                    prod_ai;
    realA                    irsq, idr4, idr6;
    realA                    raj, rvdw, ratio;
    realA                    vaj, ccf, dccf, theta, cosq;
    realA                    term, prod, icf4, icf6, gpi2, factor, sinq;
                                    ...
                                    void *                 work)
{
    ...
    realA                    rsq, rinv;
    realA                    prod, raj;
    realA                    rai, doffset, rai_inv, rai_inv2, sk_ai, sk2_ai, sum_ai;
    realA                    dr, sk, lij, dlij, lij2, lij3, uij2, uij3, diff2, uij, log_term;
    realA                    lij_inv, sk2, sk2_rinv, tmp, t1, t2, t3, raj_inv, sum_ai2, sum_ai3, tsum;
    realA                    tchain;
    realA                    dadxi, dadxj;
    realA                    rad, min_rad;
                                ...
                                void *                 work)
{
    ...
    realA                    dx, dy, dz;
    realA                    tx, ty, tz;
    realA                    rbai, rbaj, fgb, fgb_ai, rbi;
    realA              *     rb;
    realA              *     dadx;
