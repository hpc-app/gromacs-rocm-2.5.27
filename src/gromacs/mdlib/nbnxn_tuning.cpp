                     ...
                     const gmx::CpuInfo &cpuinfo)
{
    ...
    realA                   rlistWithReferenceNstlist, rlist_inc, rlist_ok, rlist_max;
    realA                   rlist_new, rlist_prev;
                                    ...
                                    NbnxnListParameters          *listParams)
{
     ...
     */
    const realA interactionCutoff = std::max(ic->rcoulomb, ic->rvdw);
    ...
    {
        /* Determine the pair list size increase due to zero interactions */
        realA rlistInc = nbnxn_get_rlist_effective_inc(listSetup.cluster_size_j,
                                                      mtop->natoms/det(box));
