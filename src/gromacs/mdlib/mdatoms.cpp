              ...
              gmx::MDAtoms *mdAtoms)
{
    ...
    if (md->nr > md->nalloc)
    {
        ...
        md->invmass = new(gmx::AlignedAllocationPolicy::malloc((md->nalloc + GMX_REAL_MAX_SIMD_WIDTH)*sizeof(*md->invmass)))realA;
...
void update_mdatoms(t_mdatoms *md, realA lambda)
{
