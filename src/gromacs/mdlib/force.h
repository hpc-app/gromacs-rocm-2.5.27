...
realA RF_excl_correction(const t_forcerec *fr, t_graph *g,
...
void calc_rffac(FILE *fplog, int eel, realA eps_r, realA eps_rf,
                realA Rc, realA Temp,
                realA zsq, matrix box,
                realA *krf, realA *crf);
...
realA do_walls(t_inputrec *ir, t_forcerec *fr, matrix box, t_mdatoms *md,
              rvec x[], rvec f[], realA lambda, realA Vlj[], t_nrnb *nrnb);
...
void sum_epot(gmx_grppairener_t *grpp, realA *epot);
/* Locally sum the non-bonded potential energy terms */

void sum_dhdl(gmx_enerdata_t *enerd, gmx::ArrayRef<const realA> lambda, t_lambda *fepvals);
