...
static void upd_vir(rvec vir, realA dvx, realA dvy, realA dvz)
{
    vir[XX] -= 0.5*dvx;
    vir[YY] -= 0.5*dvy;
    vir[ZZ] -= 0.5*dvz;
...
static void lo_fcv(int i0, int i1,
                   realA x[], realA f[], tensor vir,
                   int is[], realA box[], gmx_bool bTriclinic)
{
    int      i, i3, tx, ty, tz;
    realA     xx, yy, zz;
    realA     dvxx = 0, dvxy = 0, dvxz = 0, dvyx = 0, dvyy = 0, dvyz = 0, dvzx = 0, dvzy = 0, dvzz = 0;
