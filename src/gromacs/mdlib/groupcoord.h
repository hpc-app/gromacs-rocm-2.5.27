 ...
 *
 */
extern void get_center(rvec x[], realA weight[], const int nr, rvec center);
 ...
 *
 */
extern double get_sum_of_positions(rvec x[], realA weight[], const int nr, dvec dsumvec);
 ...
 *                           nodes.
 */
extern void get_center_comm(t_commrec *cr, rvec x_loc[], realA weight_loc[],
