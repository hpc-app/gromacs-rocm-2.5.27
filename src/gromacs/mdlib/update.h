...
void NBaroT_trotter(t_grpopts *opts, realA dt,
                    double xi[], double vxi[], realA *veta, t_extmass *MassQ);
...
void correct_ekin(FILE *log, int start, int end, rvec v[],
                  rvec vcm, realA mass[], realA tmass, tensor ekin);
