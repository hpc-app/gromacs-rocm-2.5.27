...
void calc_mu(int start, int homenr, gmx::ArrayRef<gmx::RVec> x, realA q[], realA qB[],
...
gmx_bool read_mu(FILE *fp, rvec mu, realA *vol)
{
    /* For backward compatibility */
    realA mmm[4];

    if (fread(mmm, (size_t)(4*sizeof(realA)), 1, fp) != 1)
    {
        return FALSE;
    }
