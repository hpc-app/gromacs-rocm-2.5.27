...
typedef struct {
    ...
    realA              *QMcharges;      /* atomic charges of QM atoms(ONIOM) */
    int               *shiftQM;
    ...
    realA               SAon;          /* at which energy gap the SA starts */
    realA               SAoff;         /* at which energy gap the SA stops  */
...
typedef struct {
    ...
    realA          *MMcharges;   /* MM point charges in std QMMM calc.*/
    int           *shiftMM;
...
realA calculate_QMMM(t_commrec  *cr,
                    rvec        f[],
                    t_forcerec *fr);
