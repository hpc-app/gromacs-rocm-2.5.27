...
static void update_tensor(rvec x, realA m0, tensor I)
{
    realA xy, xz, yz;
...
doStopComMotionAccelerationCorrection(int                   homenr,
                                      ...
                                      const t_vcm          &vcm)
{
    const realA xCorrectionFactor = 0.5*vcm.timeStep;
...
void check_cm_grp(FILE *fp, t_vcm *vcm, t_inputrec *ir, realA Temp_Max)
{
    int    m, g;
    realA   ekcm, ekrot, tm, tm_1, Temp_cm;
    rvec   jcm;
    tensor Icm;
