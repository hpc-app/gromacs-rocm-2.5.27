              ...
              gmx_walltime_accounting_t walltime_accounting)
{
    ...
    PaddedRVecVector f {};
    realA             lambda, t, temp, beta, drmax, epot;
    ...
    gmx_bool         bCavity;
    int              nat_cavity  = 0, d;
    realA            *mass_cavity = nullptr, mass_tot;
    int              nbin;
    double           invbinw, *bin, refvolshift, logV, bUlogV;
    realA             prescorr, enercorr, dvdlcorr;
     ...
     */
    realA bU_bin_limit      = 50;
    realA bU_logV_bin_limit = bU_bin_limit + 10;
    ...
    while (bNotLastFrame)
    {
        ...
        while (step < nsteps)
        {
            ...
            else
            {
                ...
                realA angleX = 2*M_PI*dist(rng);
                realA angleY = 2*M_PI*dist(rng);
                realA angleZ = 2*M_PI*dist(rng);
