...
static void
clear_f_all(const nbnxn_atomdata_t *nbat, realA *f)
{
    int i;
...
static void
clear_f_flagged(const nbnxn_atomdata_t *nbat, int output_index, realA *f)
{
...
void
clear_f(const nbnxn_atomdata_t *nbat, int output_index, realA *f)
{
