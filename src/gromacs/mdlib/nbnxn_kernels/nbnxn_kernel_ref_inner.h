...

{
    ...
    for (i = 0; i < UNROLLI; i++)
    {
        ...
        for (j = 0; j < UNROLLJ; j++)
        {
            ...
            realA            dx, dy, dz;
            realA            rsq, rinv;
            realA            rinvsq, rinvsix;
            realA            c6, c12;
            realA            FrLJ6 = 0, FrLJ12 = 0, frLJ = 0;
            realA            VLJ gmx_unused;
...
#ifdef LJ_EWALD
                {
                    realA            c6grid, rinvsix_nm, cr2, expmcr2, poly;
#ifdef CALC_ENERGIES
                    realA            sh_mask;
#endif
...
#ifdef CALC_ENERGIES
                    /* Shift should only be applied to realA LJ pairs */
