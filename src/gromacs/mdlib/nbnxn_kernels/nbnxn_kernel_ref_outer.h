...
)
{
    ...
    realA                xi[UNROLLI*XI_STRIDE];
    realA                fi[UNROLLI*FI_STRIDE];
    realA                qi[UNROLLI];
...
#endif
#ifdef LJ_POT_SWITCH
    realA       swV3, swV4, swV5;
    realA       swF2, swF3, swF4;
#endif
#ifdef LJ_EWALD
    realA        lje_coeff2, lje_coeff6_6;
#ifdef CALC_ENERGIES
    realA        lje_vc;
#endif
    const realA *ljc;
