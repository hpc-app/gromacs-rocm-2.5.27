...
static realA grid_atom_density(int n, rvec corner0, rvec corner1)
{
    rvec size;
...
static void sort_atoms(int dim, gmx_bool Backwards,
                       ...
                       int *a, int n, rvec *x,
                       realA h0, realA invh, int n_per_h,
                       int *sort)
{
    if (n <= 1)
    {
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        else
        {
             ...
             * Sort on realA z for minimal bounding box size.
...
static void calc_bounding_box(int na, int stride, const realA *x, nbnxn_bb_t *bb)
{
    int  i;
    realA xl, xh, yl, yh, zl, zh;
...
static void calc_bounding_box_x_x4(int na, const realA *x, nbnxn_bb_t *bb)
{
    realA xl, xh, yl, yh, zl, zh;
...
/* Packed coordinates, bb order xyz0 */
static void calc_bounding_box_x_x8(int na, const realA *x, nbnxn_bb_t *bb)
{
    realA xl, xh, yl, yh, zl, zh;
...
/* Packed coordinates, bb order xyz0 */
gmx_unused static void calc_bounding_box_x_x4_halves(int na, const realA *x,
...
static void calc_bounding_box_xxxx(int na, int stride, const realA *x, float *bb)
{
    int  i;
    realA xl, xh, yl, yh, zl, zh;
