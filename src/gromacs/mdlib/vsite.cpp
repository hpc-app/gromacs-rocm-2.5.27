...
static void constr_vsite2(const rvec xi, const rvec xj, rvec x, realA a, const t_pbc *pbc)
{
    realA b = 1 - a;
    /* 1 flop */
...
static void constr_vsite3(const rvec xi, const rvec xj, const rvec xk, rvec x, realA a, realA b,
                          const t_pbc *pbc)
{
    realA c = 1 - a - b;
    /* 2 flops */
...
static void constr_vsite3FD(const rvec xi, const rvec xj, const rvec xk, rvec x, realA a, realA b,
                            const t_pbc *pbc)
{
    rvec xij, xjk, temp;
    realA c;
...
static void constr_vsite3FAD(const rvec xi, const rvec xj, const rvec xk, rvec x, realA a, realA b, const t_pbc *pbc)
{
    rvec xij, xjk, xp;
    realA a1, b1, c1, invdij;
...
static void constr_vsite3OUT(const rvec xi, const rvec xj, const rvec xk, rvec x,
                             realA a, realA b, realA c, const t_pbc *pbc)
{
    rvec xij, xik, temp;
...
static void spread_vsite2(const t_iatom ia[], realA a,
                          const rvec x[],
                          rvec f[], rvec fshift[],
...
static void spread_vsite3(const t_iatom ia[], realA a, realA b,
                          const rvec x[],
                          rvec f[], rvec fshift[],
                          const t_pbc *pbc, const t_graph *g)
{
...
static void spread_vsite3FD(const t_iatom ia[], realA a, realA b,
                            const rvec x[],
                            rvec f[], rvec fshift[],
                            gmx_bool VirCorr, matrix dxdf,
                            const t_pbc *pbc, const t_graph *g)
{
    realA    c, invl, fproj, a1;
...
static void spread_vsite3FAD(const t_iatom ia[], realA a, realA b,
                             const rvec x[],
                             rvec f[], rvec fshift[],
                             gmx_bool VirCorr, matrix dxdf,
                             const t_pbc *pbc, const t_graph *g)
{
    ...
    realA    a1, b1, c1, c2, invdij, invdij2, invdp, fproj;
    t_iatom av, ai, aj, ak;
    int     svi, sji, skj, d;
    ivec    di;
...
static void spread_vsite3OUT(const t_iatom ia[], realA a, realA b, realA c,
                             const rvec x[],
                             rvec f[], rvec fshift[],
                             gmx_bool VirCorr, matrix dxdf,
                             const t_pbc *pbc, const t_graph *g)
...
static void spread_vsite4FD(const t_iatom ia[], realA a, realA b, realA c,
                            const rvec x[],
                            rvec f[], rvec fshift[],
                            gmx_bool VirCorr, matrix dxdf,
                            const t_pbc *pbc, const t_graph *g)
{
    realA    d, invl, fproj, a1;
...
static void spread_vsite4FDN(const t_iatom ia[], realA a, realA b, realA c,
                             const rvec x[],
                             rvec f[], rvec fshift[],
                             gmx_bool VirCorr, matrix dxdf,
                             const t_pbc *pbc, const t_graph *g)
