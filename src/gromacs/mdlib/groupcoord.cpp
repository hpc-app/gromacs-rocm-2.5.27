...
extern double get_sum_of_positions(rvec x[], realA weight[], const int nat, dvec dsumvec)
{
    int    i;
    rvec   x_weighted;
...
extern void get_center(rvec x[], realA weight[], const int nr, rvec rcenter)
{
    dvec   dcenter;
...
extern void get_center_comm(
        ...
        realA       weight_loc[], /* Local masses or other weights */
