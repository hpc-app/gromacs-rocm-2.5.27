                       ...
                       float     *cycles_pme)
{
    ...
    int         pme_flags;
    t_pbc       pbc;
    realA        dvdl_dum[efptNR], dvdl_nb[efptNR];
...
#define TAKETIME FALSE
    ...
    if (ir->nwall)
    {
        ...
        realA dvdl_walls = do_walls(ir, fr, box, md, x, forceForUseWithShiftForces, lambda[efptVDW],
...
#pragma omp parallel for num_threads(nthreads) schedule(static)
        ...
        /* Note that with separate PME nodes we get the realA energies later */
...
static realA sum_v(int n, realA v[])
{
    realA t;
    int  i;
