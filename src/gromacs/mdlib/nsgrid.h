...
typedef struct t_grid {
    ...
    realA   *dcx2;         // Squared distance from atom to j-cell
    realA   *dcy2;         // Squared distance from atom to j-cell
    realA   *dcz2;         // Squared distance from atom to j-cell
...
static const realA GRID_STDDEV_FAC = 1.73205080757;
 ...
 */
static const realA NSGRID_STDDEV_FAC = 2.0;
...
void grid_first(FILE *log, t_grid *grid,
                ...
                realA rlong, realA grid_density);
