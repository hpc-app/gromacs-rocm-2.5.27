...
static void get_nsgrid_boundaries_vac(realA av, realA stddev,
                                      realA *bound0, realA *bound1,
                                      realA *bdens0, realA *bdens1)
{
...
static void dd_box_bounds_to_ns_bounds(realA box0, realA box_size,
                                       realA *gr0, realA *gr1)
{
    realA av, stddev;
...
static void set_grid_sizes(matrix box, rvec izones_x0, rvec izones_x1, realA rlist,
                           ...
                           realA grid_density)
{
    ...
    rvec     izones_size;
    realA     inv_r_ideal, size, add_tric, radd;
...
void grid_first(FILE *fplog, t_grid *grid,
                ...
                realA rlist, realA grid_density)
{
    int    i, m;
