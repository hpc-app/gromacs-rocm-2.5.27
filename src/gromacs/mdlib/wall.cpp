...
static void wall_error(int a, rvec *x, realA r)
{
    gmx_fatal(FARGS,
              ...
              rvec x[], rvec f[], realA lambda, realA Vlj[], t_nrnb *nrnb)
{
    ...
    realA           *nbfp, lamfac, fac_d[2], fac_r[2], Cd, Cr;
    realA            wall_z[2], r, mr, r1, r2, r4, Vd, Vr, V = 0, Fd, Fr, F = 0, dvdlambda;
    dvec            xf_z;
    int             n0, nnn;
    realA            tabscale, *VFtab, rt, eps, eps2, Yt, Ft, Geps, Heps2, Fp, VV, FF;
