...
#define EKIN_WORK_BUFFER_SIZE 2
             ...
             * precision we have
             * EKIN_WORK_BUFFER_SIZE*DIM*DIM*sizeof(realA) = 72/144 bytes
...
void update_ekindata(int start, int homenr, gmx_ekindata_t *ekind,
                     t_grpopts *opts, rvec v[], t_mdatoms *md, realA lambda)
{
    int  d, g, n;
    realA mv;
...
realA sum_ekin(t_grpopts *opts, gmx_ekindata_t *ekind, realA *dekindlambda,
