...
#define NBNXN_MEM_ALIGN  (GMX_SIMD_REAL_WIDTH*sizeof(realA))
#else
...
typedef struct {
    ...
    rvec          size;             /* c1 - c0                                     */
    realA          atom_density;     /* The atom number density for the local grid  */
    ...
    realA          sx;               /* x-size of a (super-)cell                    */
    realA          sy;               /* y-size of a (super-)cell                    */
    realA          inv_sx;           /* 1/sx                                        */
    realA          inv_sy;           /* 1/sy                                        */
...
typedef struct nbnxn_list_work {
    ...
    realA                   *x_ci;            /* The coordinates, pbc shifted, for each atom       */
    realA                   *x_ci_simd;       /* aligned pointer to 4*DIM*GMX_SIMD_REAL_WIDTH floats */
