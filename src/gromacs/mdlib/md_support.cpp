                     ...
                     gmx_bool *bSumEkinhOld, int flags)
{
    ...
    realA     prescorr, enercorr, dvdlcorr, dvdl_ekin;
    ...
    if (bTemp || bStopCM || bPres || bEner || bConstrain)
    {
        ...
        {
            gmx::ArrayRef<realA> signalBuffer = signalCoordinator->getCommunicationBuffer();
            if (PAR(cr))
            {
                            ...
                            t_state *globalState)
{
    ...
    if (rerun_fr->bLambda)
    {
        ...
        else
        {
            ...
            realA frac      = step*fepvals->delta_lambda;
