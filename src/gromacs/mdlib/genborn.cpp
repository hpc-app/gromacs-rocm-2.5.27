                         ...
                         gmx_genborn_t *born, int natoms)
{
    ...
    int   i, j, m, ia, ib;
    realA  r, ri, rj, ri2, rj2, r3, r4, ratio, term, h, doffset;
                  ...
                  gmx_genborn_t *born, t_mdatoms *md)
{
    ...
    int  shift;
    realA shX, shY, shZ;
    realA gpi, dr2, idr4, rvdw, ratio, ccf, theta, term, rai, raj;
    realA ix1, iy1, iz1, jx1, jy1, jz1, dx11, dy11, dz11;
    realA rinv, idr2, idr6, vaj, dccf, cosq, sinq, prod, gpi2;
    realA factor;
    realA vai, prod_ai, icf4, icf6;
                ...
                gmx_genborn_t *born, t_mdatoms *md)
{
    ...
    int   shift;
    realA  shX, shY, shZ;
    realA  rai, raj, dr2, dr, sk, sk_ai, sk2, sk2_ai, lij, uij, diff2, tmp, sum_ai;
    realA  rad, min_rad, rinv, rai_inv;
    realA  ix1, iy1, iz1, jx1, jy1, jz1, dx11, dy11, dz11;
    realA  lij2, uij2, lij3, uij3, t1, t2, t3;
    realA  lij_inv, dlij, sk2_rinv, prod, log_term;
    realA  doffset, raj_inv, dadx_val;
    realA *gb_radius;
                ...
                rvec x[], t_nblist *nl, gmx_genborn_t *born, t_mdatoms *md)
{
    ...
    int   shift;
    realA  shX, shY, shZ;
    realA  rai, raj, dr2, dr, sk, sk2, lij, uij, diff2, tmp, sum_ai;
    realA  sum_ai2, sum_ai3, tsum, tchain, rinv, rai_inv, lij_inv, rai_inv2;
    realA  log_term, prod, sk2_rinv, sk_ai, sk2_ai;
    realA  ix1, iy1, iz1, jx1, jy1, jz1, dx11, dy11, dz11;
    realA  lij2, uij2, lij3, uij3, dlij, t1, t2, t3;
    realA  doffset, raj_inv, dadx_val;
    realA *gb_radius;
                ...
                rvec x[], t_nblist *nl, gmx_genborn_t *born, t_mdatoms *md, t_nrnb     *nrnb)
{
    ...
    if (fr->bAllvsAll && fr->dadx == nullptr)
    {
        ...
        fr->dadx = (realA *) (((size_t) fr->dadx_rawptr + 16) & (~((size_t) 15)));
    }
    else
    {
...
realA gb_bonds_tab(rvec x[], rvec f[], rvec fshift[], realA *charge, realA *p_gbtabscale,
                  ...
                  realA gb_epsilon_solvent, realA facel, const t_pbc *pbc, const t_graph *graph)
{
    ...
    realA     r, rsq11;
    realA     rinv11, iq;
    realA     isaprod, qq, gbscale, gbtabscale, Y, F, Geps, Heps2, Fp, VV, FF, rt, eps, eps2;
    realA     vgb, fgb, fijC, dvdatmp, fscal;
    realA     vctot;
...
static realA calc_gb_selfcorrections(t_commrec *cr, int natoms,
                                    realA *charge, gmx_genborn_t *born, realA *dvda, double facel)
{
    int  i, ai, at0, at1;
    realA rai, e, derb, q, q2, fi, rai_inv, vtot;
...
static realA calc_gb_nonpolar(t_commrec *cr, t_forcerec *fr, int natoms, gmx_genborn_t *born, gmx_localtop_t *top,
                             realA *dvda, t_mdatoms *md)
{
    int  ai, i, at0, at1;
    realA e, es, rai, term, probe, tmp, factor;
    realA rbi_inv, rbi_inv2;
...
static realA calc_gb_chainrule(int natoms, t_nblist *nl, realA *dadx, realA *dvda, rvec x[], rvec t[], rvec fshift[],
                              rvec shift_vec[], int gb_algorithm, gmx_genborn_t *born)
{
    int          i, k, n, ai, aj, nj0, nj1, n0, n1;
    int          shift;
    realA         shX, shY, shZ;
    realA         fgb, rbi, fix1, fiy1, fiz1;
    realA         ix1, iy1, iz1, jx1, jy1, jz1, dx11, dy11, dz11;
    realA         tx, ty, tz, rbai, rbaj, fgb_ai;
    realA        *rb;
