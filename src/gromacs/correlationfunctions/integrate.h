 ...
 * \return The integral
 */
realA print_and_integrate(FILE *fp, int n, realA dt, const realA c[], const realA *fit, int nskip);
 ...
 * \return the integral
 */
realA evaluate_integral(int n, const realA x[], const realA y[], const realA dy[], realA aver_start,
                       realA *stddev);
