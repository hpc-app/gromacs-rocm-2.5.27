...
realA do_lmfit(int ndata, realA c1[], realA sig[], realA dt, realA *x0,
              realA begintimefit, realA endtimefit, const gmx_output_env_t *oenv,
...
realA fit_acf(int ncorr, int fitfn, const gmx_output_env_t *oenv, gmx_bool bVerbose,
             realA tbeginfit, realA tendfit, realA dt, realA c1[], realA *fit)
{
    double      fitparm[3];
