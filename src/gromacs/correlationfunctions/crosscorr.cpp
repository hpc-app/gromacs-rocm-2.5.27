 ...
 */
static void cross_corr_low(int n, realA f[], realA g[], realA corr[], gmx_fft_t fft)
{
    int             i;
...
void cross_corr(int n, realA f[], realA g[], realA corr[])
{
    gmx_fft_t fft;
...
void many_cross_corr(int nFunc, int * nData, realA ** f, realA ** g, realA ** corr)
{
#pragma omp parallel
