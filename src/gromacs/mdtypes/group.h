...
typedef struct {
    realA    Th;             /* Temperature at half step        */
    realA    T;              /* Temperature at full step        */
    ...
    realA    lambda;         /* Berendsen coupling lambda       */
...
typedef struct {
    realA    cos_accel;  /* The acceleration for the cosine profile      */
    realA    mvcos;      /* The cos momenta of home particles            */
    realA    vcos;       /* The velocity of the cosine profile           */
} t_cos_acc;
...
typedef struct gmx_ekindata_t {
    ...
    realA           **dekindl_work;    /* Work location for dekindl per thread */
    ...
    realA             dekindl;         /* dEkin/dlambda at half step           */
    realA             dekindl_old;     /* dEkin/dlambda at old half step       */
