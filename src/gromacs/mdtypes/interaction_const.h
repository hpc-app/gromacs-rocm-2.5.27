...
struct interaction_const_t
{
    ...
    /* Coulomb */
    realA rcoulomb;
    realA rcoulomb_switch;

    /* PME/Ewald */
    realA ewaldcoeff_q;
    realA ewaldcoeff_lj;
    int  ljpme_comb_rule; /* LJ combination rule for the LJ PME mesh part */
    realA sh_ewald;        /* -sh_ewald is added to the direct space potential */
    realA sh_lj_ewald;     /* sh_lj_ewald is added to the correction potential */
