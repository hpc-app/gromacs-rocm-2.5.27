...
static void cmp_grpopts(FILE *fp, const t_grpopts *opt1, const t_grpopts *opt2, realA ftol, realA abstol)
{
    int  i, j;
...
static void cmp_awhDimParams(FILE *fp, const gmx::AwhDimParams *dimp1, const gmx::AwhDimParams *dimp2, int dimIndex, realA ftol, realA abstol)
{
...
static void cmp_awhBiasParams(FILE *fp, const gmx::AwhBiasParams *bias1, const gmx::AwhBiasParams *bias2, int biasIndex, realA ftol, realA abstol)
{
...
static void cmp_awhParams(FILE *fp, const gmx::AwhParams *awh1, const gmx::AwhParams *awh2, realA ftol, realA abstol)
{
...
static void cmp_simtempvals(FILE *fp, const t_simtemp *simtemp1, const t_simtemp *simtemp2, int n_lambda, realA ftol, realA abstol)
{
    int i;
...
static void cmp_expandedvals(FILE *fp, const t_expanded *expand1, const t_expanded *expand2, int n_lambda, realA ftol, realA abstol)
{
    int i;
...
static void cmp_fepvals(FILE *fp, const t_lambda *fep1, const t_lambda *fep2, realA ftol, realA abstol)
{
    int i, j;
