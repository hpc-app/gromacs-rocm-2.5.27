...
struct gmx_grppairener_t
{
    ...
    realA *ener[egNR]; /* Energy terms for each pair of groups */
};

struct gmx_enerdata_t
{
    realA                     term[F_NRE];         /* The energies for all different interaction types */
    ...
    realA                     foreign_term[F_NRE]; /* alternate array for storing foreign lambda energies */
...
struct t_forcerec {
    ...
    gmx_bool bBHAM;
    realA    *nbfp;
    realA    *ljpme_c6grid; /* C6-values used on grid in LJPME */
