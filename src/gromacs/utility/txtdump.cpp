...
void pr_reals(FILE *fp, int indent, const char *title, const realA *vec, int n)
{
    int i;
...
void pr_reals_of_dim(FILE *fp, int indent, const char *title, const realA *vec, int n, int dim)
{
    int         i, j;
...
void pr_real(FILE *fp, int indent, const char *title, realA r)
{
    pr_indent(fp, indent);
    fprintf(fp, "%-30s = %g\n", title, r);
}
