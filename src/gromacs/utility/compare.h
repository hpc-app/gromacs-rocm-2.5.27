...
//! Compares two realA values for equality.
gmx_bool equal_real(realA i1, realA i2, realA ftol, realA abstol);
...
gmx_bool equal_double(double i1, double i2, realA ftol, realA abstol);
...
void cmp_real(FILE *fp, const char *s, int index, realA i1, realA i2, realA ftol, realA abstol);
