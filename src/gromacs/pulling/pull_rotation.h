 ...
 */
extern void do_rotation(struct t_commrec *cr, t_inputrec *ir, matrix box, rvec x[], realA t,
 ...
 */
extern realA add_rot_forces(t_rot *rot, rvec f[], struct t_commrec *cr, gmx_int64_t step, realA t);
