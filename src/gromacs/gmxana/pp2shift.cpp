...
static realA interpolate(realA phi, realA psi, t_shiftdata *sd)
{
    int  iphi, ipsi, iphi1, ipsi1;
    realA fphi, fpsi, wx0, wx1, wy0, wy1;
...
static void dump_sd(const char *fn, t_shiftdata *sd)
{
    ...
    realA   phi, psi, *x_phi, *y_psi, **newdata;
    realA   lo, hi;
...
void do_pp2shifts(FILE *fp, int nf, int nlist, t_dlist dlist[], realA **dih)
{
