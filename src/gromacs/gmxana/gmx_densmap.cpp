...
int gmx_densmap(int argc, char *argv[])
{
    ...
    static realA        xmin    = -1, xmax = -1, bin = 0.02, dmin = 0, dmax = 0, amax = 0, rmax = 0;
    ...
    realA             **grid, maxgrid, m1, m2, box1, box2, *tickx, *tickz, invcellvol;
    realA               invspa = 0, invspz = 0, axial, r, vol_old, vol, rowsum;
    int                nlev   = 51;
