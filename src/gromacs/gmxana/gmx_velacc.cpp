...
static void precalc(const t_topology &top, realA normm[])
{
...
static void calc_spectrum(int n, realA c[], realA dt, const char *fn,
...
#define NFILE asize(fnm)
    ...
    if (counter >= 4)
    {
        ...
        {
            calc_spectrum(counter/2, (realA *) (c1[0]), (t1-t0)/2, opt2fn("-os", NFILE, fnm),
                          oenv, bRecip);
