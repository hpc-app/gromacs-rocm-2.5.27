...
static void periodic_dist(int ePBC,
                          ...
                          realA *rmin, realA *rmax, int *min_ind)
{
#define NSHIFT_MAX 26
    int  nsz, nshift, sx, sy, sz, i, j, s;
    realA sqr_box, r2min, r2max, r2;
...
static void calc_dist(realA rcut, gmx_bool bPBC, int ePBC, matrix box, rvec x[],
                      int nx1, int nx2, int index1[], int index2[],
                      gmx_bool bGroup,
                      realA *rmin, realA *rmax, int *nmin, int *nmax,
...
static void dist_plot(const char *fn, const char *afile, const char *dfile,
                      ...
                      realA rcut, gmx_bool bMat, const t_atoms *atoms,
                      ...
                      const gmx_output_env_t *oenv)
{
    ...
    char             buf[256];
    char           **leg;
    realA             t, dmin, dmax, **mindres = nullptr, **maxdres = nullptr;
    int              nmin, nmax;
    t_trxstatus     *status;
    int              i = -1, j, k;
