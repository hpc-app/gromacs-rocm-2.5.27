...
static realA calc_mass(t_atoms *atoms, gmx_bool bGetMass, gmx_atomprop_t aps)
{
    realA tmass;
    int  i;
...
static realA calc_geom(int isize, int *index, rvec *x, rvec geom_center, rvec minval,
...
{
    realA bfac_min, bfac_max, xmin, ymin, zmin;
    int  i;
    int  space = ' ';
...
{
    rvec rotvec;
    realA ux, uy, uz, costheta, sintheta;
...
int gmx_editconf(int argc, char *argv[])
{
    ...
    { 0, 0, 0 }, newang     =
    { 90, 90, 90 };
    static realA rho          = 1000.0, rvdw = 0.12;
    static rvec center       =
    { 0, 0, 0 }, translation =
    { 0, 0, 0 }, rotangles   =
    { 0, 0, 0 }, aligncenter =
