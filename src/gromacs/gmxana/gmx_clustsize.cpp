...
static void clust_size(const char *ndx, const char *trx, const char *xpm,
                       ...
                       realA cut, int nskip, int nlevels,
                       ...
                       const gmx_output_env_t *oenv)
{
    ...
    realA                **cs_dist = nullptr;
    realA                  tf, dx2, cut2, *t_x = nullptr, *t_y, cmid, cmax, cav, ekin;
            ...
            else
            {
                ...
                if (max_clust_ind >= 0)
                {
                    ...
                    for (i = 0; (i < nindex); i++)
                    {
                        ...
                        {
                            ai      = index[i];
                            realA            m  = mtopGetAtomMass(mtop, ai, &molb);
    ...
    /* Print the realA distribution cluster-size/numer, averaged over the trajectory. */
