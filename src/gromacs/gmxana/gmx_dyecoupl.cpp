...
#define NFILE asize(fnm)
    ...
    realA       *rvalues = nullptr, *kappa2values = nullptr, *rhist = nullptr, *khist = nullptr;
    t_pbc      *pbc     = nullptr;
    int         i, bin;
    ...
    realA        R, kappa2, insteff, Rs = 0., kappa2s = 0., insteffs = 0., rmax, rmin, kmin = 0., kmax = 4.,
