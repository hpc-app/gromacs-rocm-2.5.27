...
static realA calc_gyro(rvec x[], int gnx, int index[], t_atom atom[], realA tm,
                      rvec gvec, rvec d, gmx_bool bQ, gmx_bool bRot, gmx_bool bMOI, matrix trans)
{
    int    i, ii, m;
    realA   gyro, dx2, m0, Itot;
    rvec   comp;
