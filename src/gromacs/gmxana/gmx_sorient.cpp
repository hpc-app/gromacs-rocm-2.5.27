...
int gmx_sorient(int argc, char *argv[])
{
    ...
    realA             *histi1, *histi2, invbw, invrbw;
    double            sum1, sum2;
    int              *isize, nrefgrp, nrefat;
    int             **index;
    char            **grpname;
    realA              inp, outp, nav, normfac, rmin2, rmax2, rcut, rcut2, r2, r;
    realA              c1, c2;
    char              str[STRLEN];
    gmx_bool          bTPS;
    ...
    static realA       rmin = 0.0, rmax = 0.5, binwidth = 0.02, rbinw = 0.02;
    t_pargs           pa[] = {
...
#define NFILE asize(fnm)
    ...
    nav     = static_cast<realA>(ntot)/(nrefgrp*nf);
    normfac = invbw/ntot;
