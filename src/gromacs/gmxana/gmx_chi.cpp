...
static gmx_bool bAllowed(realA phi, realA psi)
{
...
static void do_dihcorr(const char *fn, int nf, int ndih, realA **dih, realA dt,
                       int nlist, t_dlist dlist[], realA time[], int maxchi,
...
static void copy_dih_data(realA in[], realA out[], int nf, gmx_bool bLEAVE)
{
...
static void dump_em_all(int nlist, t_dlist dlist[], int nf, realA time[],
                        realA **dih, int maxchi,
...
static void reset_one(realA dih[], int nf, realA phase)
{
    int j;
...
static void do_rama(int nf, int nlist, t_dlist dlist[], realA **dih,
...
#define NMAT 120
    realA   **mat  = nullptr, phi, psi, omega, axis[NMAT], lo, hi;
...
static void order_params(FILE *log,
                         ...
                         const char *pdbfn, realA bfac_init,
...
int gmx_chi(int argc, char *argv[])
{
    ...
    static realA        bfac_init   = -1.0, bfac_max = 0;
    ...
    realA               dt = 0, traj_t_ns;
    gmx_output_env_t  *oenv;
    gmx_residuetype_t *rt;

    int                isize, *index;
    int                ndih, nactdih, nf;
    realA             **dih, *trans_frac, *aver_angle, *time;
