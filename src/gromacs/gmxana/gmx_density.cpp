...
static void calc_electron_density(const char *fn, int **index, int gnx[],
                                  ...
                                  int ePBC,
                                  int axis, int nr_grps, realA *slWidth,
...
static void calc_density(const char *fn, int **index, int gnx[],
                         ...
                         int axis, int nr_grps, realA *slWidth, gmx_bool bCenter,
                         int *index_center, int ncenter,
                         gmx_bool bRelative, const gmx_output_env_t *oenv, const char **dens_opt)
{
    ...
    realA         t,
                 z;
    realA         boxSz, aveBox;
    realA        *den_val; /* values from which the density is calculated */
    gmx_rmpbc_t  gpbc = nullptr;
...
static void plot_density(double *slDensity[], const char *afile, int nslices,
                         int nr_grps, char *grpname[], realA slWidth,
                         const char **dens_opt,
...
int gmx_density(int argc, char *argv[])
{
    ...
    realA               slWidth;        /* width of one slice         */
