...
static void wheel(const char *fn, int nres, char *resnm[], int r0, realA rot0, char *title)
{
    const realA fontsize  = 16;
    const realA gray      = 0.9;
    const realA fontasp   = 0.6;
    const realA fontwidth = fontsize*fontasp;

    t_psdata   out;
    int        i, sl, slen;
    realA       ring, inner, outer;
    realA       xc, yc, box;
    gmx_bool  *bPh;
    char     **rnms;
    char       sign;
...
static void wheel2(const char *fn, int nres, char *resnm[], realA rot0, char *title)
{
    const realA fontsize  = 14;
    const realA gray      = 0.9;
    const realA fontasp   = 0.45;
    const int  angle     = 9;
    const realA fontwidth = fontsize*fontasp;
