...
static void do_trunc(const char *fn, realA t0)
{
    t_fileio        *in;
    FILE            *fp;
    gmx_bool         bStop, bOK;
...
int gmx_trjconv(int argc, char *argv[])
{
    ...
    static realA      tzero         = 0, delta_t = 0, timestep = 0, ttrunc = -1, tdump = -1, split_t = 0;
    static rvec      newbox        = {0, 0, 0}, shift = {0, 0, 0}, trans = {0, 0, 0};
    static char     *exec_command  = nullptr;
    static realA      dropunder     = 0, dropover = 0;
