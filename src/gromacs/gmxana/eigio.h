...
extern void read_eigenvectors(const char *file, int *natoms, gmx_bool *bFit,
                              ...
                              int *nvec, int **eignr, rvec ***eigvec, realA **eigval);
...
extern void write_eigenvectors(const char *trrname, int natoms, const realA mat[],
                               gmx_bool bReverse, int begin, int end,
                               int WriteXref, const rvec *xref, gmx_bool bDMR,
                               const rvec xav[], gmx_bool bDMA, const realA *eigval);
