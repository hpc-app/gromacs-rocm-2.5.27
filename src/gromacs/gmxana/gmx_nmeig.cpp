...
static realA *allocateEigenvectors(int nrow, int first, int last,
                                  bool ignoreBegin)
{
    int numVector;
    if (ignoreBegin)
...
int gmx_nmeig(int argc, char *argv[])
{
    ...
    realA                  *eigenvalues;
    realA                  *eigenvectors;
    realA                   qcvtot, qutot, qcv, qu;
    int                    i, j, k;
    t_tpxheader            tpx;
    realA                   value, omega, nu;
    realA                   factor_gmx_to_omega2;
    realA                   factor_omega_to_wavenumber;
    realA                  *spectrum = nullptr;
    realA                   wfac;
