...
extern void set_mat_entry(t_mat *m, int i, int j, realA val);

extern void done_mat(t_mat **m);

extern realA mat_energy(t_mat *mat);

extern void swap_mat(t_mat *m);

extern void low_rmsd_dist(const char *fn, realA maxrms, int nn, realA **mat,
