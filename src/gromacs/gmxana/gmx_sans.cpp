...
int gmx_sans(int argc, char *argv[])
{
    ...
    static realA          binwidth = 0.2, grid = 0.05; /* bins shouldn't be smaller then smallest bond (~0.1nm) length */
    static realA          start_q  = 0.0, end_q = 2.0, q_step = 0.01;
    static realA          mcover   = -1;
