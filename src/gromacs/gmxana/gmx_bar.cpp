...
static void read_bar_xvg_lowlevel(const char *fn, realA *temp, xvg_t *ba,
                                  lambda_components_t *lc)
{
    int          i;
...
static void read_bar_xvg(char *fn, realA *temp, sim_data_t *sd)
{
    xvg_t     *barsim;
    samples_t *s;
    int        i;
...
static void read_barsim_edr(char *fn, realA *temp, sim_data_t *sd)
{
    int            i, j;
    ener_file_t    fp;
    t_enxframe    *fr;
...
int gmx_bar(int argc, char *argv[])
{
    ...
    static realA        begin    = 0, end = -1, temp = -1;
