...
static void rot_conf(t_atoms *atoms, const rvec x[], const rvec v[], realA trans, realA angle,
                     rvec head, rvec tail, int isize, int index[],
                     rvec xout[], rvec vout[])
{
    rvec     arrow, xcm;
    realA     theta, phi, arrow_len;
...
int gmx_dyndom(int argc, char *argv[])
{
    ...
    static realA       trans0 = 0;
    static rvec       head   = { 0, 0, 0 };
    static rvec       tail   = { 0, 0, 0 };
    static realA       angle0 = 0, angle1 = 0, maxangle = 0;
