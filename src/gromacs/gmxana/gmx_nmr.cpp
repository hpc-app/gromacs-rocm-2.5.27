...
static realA       minthird = -1.0/3.0, minsixth = -1.0/6.0;
...
static realA blk_value(t_enxblock *blk, int sub, int index)
{
...
static void get_orires_parms(const char *topnm, t_inputrec *ir,
                             int *nor, int *nex, int **label, realA **obs)
{
    gmx_mtop_t      mtop;
    t_topology      top;
    t_iparams      *ip;
...
static int get_bounds(const char *topnm,
                      realA **bounds, int **index, int **dr_pair, int *npairs,
...
static void calc_violations(realA rt[], realA rav3[], int nb, int index[],
                            realA bounds[], realA *viol, double *st, double *sa)
{
    const   realA sixth = 1.0/6.0;
    int          i, j;
...
static void analyse_disre(const char *voutfn,    int nframes,
                          realA violaver[], realA bounds[], int index[],
...
int gmx_nmr(int argc, char *argv[])
{
    ...
    realA              *bounds  = NULL, *violaver = NULL, *oobs = NULL, *orient = NULL, *odrms = NULL;
