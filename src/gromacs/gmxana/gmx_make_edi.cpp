...
static void write_eigvec(FILE* fp, int natoms, int eig_list[], rvec** eigvecs, int nvec, const char *grouptitle, realA steps[])
{
...
static void write_the_whole_thing(FILE* fp, t_edipar *edpars, rvec** eigvecs,
                                  int nvec, int *eig_listen[], realA* evStepList[])
{
/* write edi-file */
...
static void read_eigenvalues(int vecs[], const char *eigfile, realA values[],
                             gmx_bool bHesse, realA kT, int natoms_average_struct)
{
    int      neig, nrow, i;
    double **eigval;
...
static realA *scan_vecparams(const char *str, const char * par, int nvecs)
{
...
int gmx_make_edi(int argc, char *argv[])
{
    ...
    static realA      * evStepList[evStepNr];
    static realA        radstep  = 0.0;
    static realA        deltaF0  = 150;
    static realA        deltaF   = 0;
    static realA        tau      = .1;
    static realA        constEfl = 0.0;
    static realA        alpha    = 1;
    static int         eqSteps  = 0;
    static int       * listen[evNr];
    static realA        T         = 300.0;
    const realA         kB        = 2.5 / 300.0; /* k_boltzmann in MD units */
...
#define NPA asize(pa)
    ...
    int               nvecs;
    realA             *eigval1 = nullptr; /* in V3.3 this is parameter of read_eigenvectors */
