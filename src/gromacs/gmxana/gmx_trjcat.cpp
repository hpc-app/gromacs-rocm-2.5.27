...
static void scan_trj_files(char **fnms, int nfiles, realA *readtime,
                           realA *timestep, int imax,
...
static void sort_files(char **fnms, realA *settime, int nfile)
{
    int   i, j, minidx;
    realA  timeswap;
    char *chptr;
...
static void edit_files(char **fnms, int nfiles, realA *readtime, realA *timestep,
                       realA *settime, int *cont_type, gmx_bool bSetTime,
...
static void do_demux(int nset, char *fnms[], char *fnms_out[], int nval,
                     realA **value, realA *time, realA dt_remd, int isize,
                     int index[], realA dt, const gmx_output_env_t *oenv)
{
    int           i, j, k, natoms;
    t_trxstatus **fp_in, **fp_out;
    gmx_bool      bCont, *bSet;
    realA          t, first_time = 0;
    t_trxframe   *trx;
...
#define npargs asize(pa)
    ...
    realA             *readtime, *timest, *settime;
    realA              first_time  = 0, lasttime, last_ok_t = -1, timestep;
    gmx_bool          lastTimeSet = FALSE;
    realA              last_frame_time, searchtime;
    int               isize = 0, j;
    int              *index = nullptr, imax;
    char             *grpname;
    realA            **val = nullptr, *t = nullptr, dt_remd;
