...
static t_liedata *analyze_names(int nre, gmx_enxnm_t *names, const char *ligand)
{
    ...
    /* Now realA analysis: find components of energies */
...
static realA calc_lie(t_liedata *ld, t_energy ee[], realA lie_lj, realA lie_qq,
                     realA fac_lj, realA fac_qq)
{
    int  i;
    realA lj_tot, qq_tot;
...
int gmx_lie(int argc, char *argv[])
{
    ...
    static realA        lie_lj = 0, lie_qq = 0, fac_lj = 0.181, fac_qq = 0.5;
