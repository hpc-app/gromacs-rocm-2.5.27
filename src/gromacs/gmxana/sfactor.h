...
int gmx_structurefactors_get_sf(gmx_structurefactors_t *gsf, int elem, realA a[4], realA b[4], realA *c);

realA **gmx_structurefactors_table(gmx_structurefactors_t *gsf, realA momentum, realA ref_k,
                                  realA lambda, int n_angles);
...
realA **compute_scattering_factor_table (gmx_structurefactors_t *gsf, structure_factor_t * sft);
