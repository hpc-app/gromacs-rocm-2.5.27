...
gmx_bool convolution(int dataSize, realA *x, int kernelSize, realA* kernel)
{
    int   i, j, k;
    realA *out;
    snew(out, dataSize);
...
gmx_bool periodic_convolution(int datasize, realA *x, int kernelsize,
                              realA *kernel)
{
    int   i, j, idx;
    realA *filtered;
 ...
 */
void gausskernel(realA *out, int n, realA var)
{
    int  i, j = 0, k;
    realA arg, tot = 0;
    k = n/2;
