...
extern void compute_structure_factor (structure_factor_t * sft, matrix box,
                                      reduced_atom_t * red, int isize, realA start_q,
                                      realA end_q, int group, realA **sf_table)
{
...
/*
 * The big loop...
 * compute realA and imaginary part of the structure factor for every
 * (kx,ky,kz))
 */
    fprintf(stderr, "\n");
    for (i = 0; i < maxkx; i++)
...
extern int gmx_structurefactors_get_sf(gmx_structurefactors_t *gsf, int elem, realA a[4], realA b[4], realA *c)
{
...
extern int do_scattering_intensity (const char* fnTPS, const char* fnNDX,
                                    ...
                                    const char* fnDAT,
                                    realA start_q, realA end_q,
                                    realA energy, int ng, const gmx_output_env_t *oenv)
{
...
extern void save_data (structure_factor_t *sft, const char *file, int ngrps,
                       realA start_q, realA end_q, const gmx_output_env_t *oenv)
{
...
extern realA **gmx_structurefactors_table(gmx_structurefactors_t *gsf, realA momentum, realA ref_k, realA lambda, int n_angles)
{
...
extern realA **compute_scattering_factor_table (gmx_structurefactors_t *gsf, structure_factor_t *sft)
{
/*
