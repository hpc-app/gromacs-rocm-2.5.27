...
static realA dointerp(int n, rvec x1[], rvec x2[], rvec xx[],
                     int I, int N, realA first, realA last)
{
    int    i, j;
...
#define NFILE asize(fnm)
    ...
    static  realA      first   = 0.0;
    static  realA      last    = 1.0;
