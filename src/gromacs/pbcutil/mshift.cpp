                          ...
                          int nbond[])
{
    ...
    /* First add all the realA bonds: they should determine the molecular
     * graph.
     */
    for (i = 0; (i < F_NRE); i++)
    {
...
static realA maxEdgeLength(const t_graph g,
                          int           ePBC,
                          const matrix  box,
                          const rvec    x[])
{
