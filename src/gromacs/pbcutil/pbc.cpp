...
realA max_cutoff2(int ePBC, const matrix box)
{
    realA       min_hv2, min_ss;
    const realA oneFourth = 0.25;
...
//! Do the realA arithmetic for filling the pbc struct
