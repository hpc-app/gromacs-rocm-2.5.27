...
typedef struct swap_compartment
{
    ...
    realA               nMolAv;                /**< Time-averaged number of molecules matching
    ...
    realA              *dist;                  /**< Distance of atom to bulk layer, which is
...
typedef struct swap_group
{
    ...
    realA              q;                      /**< Total charge of one molecule of this group            */
    int              *c_ind_loc;              /**< Position of local atoms in the
                                                   collective array, [0..nat_loc]                        */
    realA             *m;                      /**< Masses (can be omitted, size apm)                     */
    ...
    realA              vacancy[eCompNR];       /**< How many molecules need to be swapped in?             */
...
typedef struct t_swap
{
    ...
    realA              deltaQ;                        /**< The charge imbalance between the compartments.  */
} t_swap;
        ...
        realA *distance_from_b)
{
    ...
    *distance_from_b = (realA)fabs(x - bulkOffset*0.5*width);
...
static void get_compartment_boundaries(
        ...
        t_swap *s,
        const matrix box,
        realA *left, realA *right)
{
    realA pos0, pos1;
    realA leftpos, rightpos, leftpos_orig;
        ...
        gmx_bool        bIsSolvent)
{
    ...
    realA             cyl0_r2 = sc->cyl0r * sc->cyl0r;
    realA             cyl1_r2 = sc->cyl1r * sc->cyl1r;
...
static realA getRequestedChargeImbalance(t_swap *s)
{
    int        ig;
    realA       DeltaQ = 0.0;
    t_swapgrp *g;
    realA       particle_charge;
    realA       particle_number[eCompNR];
