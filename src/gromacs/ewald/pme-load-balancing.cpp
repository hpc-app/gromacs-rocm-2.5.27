...
struct pme_setup_t {
    realA              rcut_coulomb;    /**< Coulomb cut-off                              */
    realA              rlistOuter;      /**< cut-off for the outer pair-list              */
    realA              rlistInner;      /**< cut-off for the inner pair-list              */
    realA              spacing;         /**< (largest) PME grid spacing                   */
    ivec              grid;            /**< the PME grid dimensions                      */
    realA              grid_efficiency; /**< ineffiency factor for non-uniform grids <= 1 */
    realA              ewaldcoeff_q;    /**< Electrostatic Ewald coefficient            */
    realA              ewaldcoeff_lj;   /**< LJ Ewald coefficient, only for the call to send_switchgrid */
...
const realA loadBalanceTriggerFactor = 1.05;
 ...
 */
const realA relativeEfficiencyFactor = 1.05;
/*! \brief Rerun until a run is 12% slower setups than the fastest run so far */
const realA maxRelativeSlowdownAccepted = 1.12;
 ...
 */
const realA maxFluctuationAccepted = 1.02;
...
struct pme_load_balancing_t {
    ...
    realA         cut_spacing;        /**< the minimum cutoff / PME grid spacing ratio */
    realA         rcut_vdw;           /**< Vdw cutoff (does not change) */
    realA         rcut_coulomb_start; /**< Initial electrostatics cutoff */
    realA         rbufOuter_coulomb;  /**< the outer pairlist buffer size */
    realA         rbufOuter_vdw;      /**< the outer pairlist buffer size */
    realA         rbufInner_coulomb;  /**< the inner pairlist buffer size */
    realA         rbufInner_vdw;      /**< the inner pairlist buffer size */
