...
#if GMX_MPI
void
gmx_sum_qgrid_dd(gmx_pme_t *pme, realA *grid, int direction);
#endif

int
copy_pmegrid_to_fftgrid(const gmx_pme_t *pme, realA *pmegrid, realA *fftgrid, int grid_index);

int
copy_fftgrid_to_pmegrid(gmx_pme_t *pme, const realA *fftgrid, realA *pmegrid, int grid_index,
                        int nthread, int thread);

void
wrap_periodic_pmegrid(const gmx_pme_t *pme, realA *pmegrid);

void
unwrap_periodic_pmegrid(gmx_pme_t *pme, realA *pmegrid);
