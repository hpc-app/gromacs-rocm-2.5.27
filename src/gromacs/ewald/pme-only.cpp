...
struct gmx_pme_pp {
    ...
    gmx::HostVector<realA>      chargeA;
    std::vector<realA>          chargeB;
    std::vector<realA>          sqrt_c6A;
    std::vector<realA>          sqrt_c6B;
    std::vector<realA>          sigmaA;
    std::vector<realA>          sigmaB;
    //@}
...
static gmx_pme_t *gmx_pmeonly_switch(std::vector<gmx_pme_t *> *pmedata,
                                     ...
                                     realA ewaldcoeff_q, realA ewaldcoeff_lj,
...
static void gmx_pme_send_force_vir_ener(gmx_pme_pp *pme_pp,
                                        const rvec *f,
                                        matrix vir_q, realA energy_q,
                                        matrix vir_lj, realA energy_lj,
                ...
                t_inputrec *ir, PmeRunMode runMode)
{
    ...
    realA               energy_q, energy_lj, dvdlambda_q, dvdlambda_lj;
    matrix             vir_q, vir_lj;
    float              cycles;
    int                count;
    ...
    do /****** this is a quasi-loop over time steps! */
    {
        ...
        do
        {
            ...
            realA ewaldcoeff_q   = 0, ewaldcoeff_lj = 0;
