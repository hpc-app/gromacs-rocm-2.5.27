...
#if GMX_MPI
void gmx_sum_qgrid_dd(struct gmx_pme_t *pme, realA *grid, int direction)
{
...
int copy_pmegrid_to_fftgrid(const gmx_pme_t *pme, realA *pmegrid, realA *fftgrid, int grid_index)
{
...
int copy_fftgrid_to_pmegrid(struct gmx_pme_t *pme, const realA *fftgrid, realA *pmegrid, int grid_index,
...
void wrap_periodic_pmegrid(const gmx_pme_t *pme, realA *pmegrid)
{
...
void unwrap_periodic_pmegrid(struct gmx_pme_t *pme, realA *pmegrid)
{
                             ...
                             realA **fraction_shift)
{
    ...
    for (int i = 0; i < arraySize; i++)
    {
        ...
        if (local_range < n)
        {
             ...
             * between zero and values close to the precision of a realA,
