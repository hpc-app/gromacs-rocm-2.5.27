...
static const realA lb_scale_factor[] = {
...
static const realA lb_scale_factor_symm[] = { 2.0/64, 12.0/64, 30.0/64, 20.0/64 };
...
struct pmegrid_t{
    ...
    realA *grid;   /* The grid local thread, size n             */
};
...
struct pmegrids_t{
    ...
    realA      *grid_all;     /* Allocated array for the grids in *grid_th        */
...
struct gmx_pme_t {
    ...
    int        pme_order;
    realA       ewaldcoeff_q;  /* Ewald splitting coefficient for Coulomb */
    realA       ewaldcoeff_lj; /* Ewald splitting coefficient for r^-6 */
    realA       epsilon_r;
     ...
     * memory alignment, pmegrid_nz_base gives the realA base size.
     */
    int     pmegrid_nz_base;
    ...
    realA                    **fftgrid; /* Grids for FFT. With 1D FFT decomposition this can be a pointer */
    ...
    realA                 *bufr;          /* Communication buffer */
