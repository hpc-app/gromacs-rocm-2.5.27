...
//! Charges
typedef ArrayRef<const realA> ChargesVector;
//! Coordinates
 ...
 */
typedef ArrayRef<const realA> SplineParamsDimVector;
...
//! Non-zero realA grid values
typedef SparseGridValuesInput<realA> SparseRealGridValuesInput;
...
//! Non-zero realA grid values
typedef SparseGridValuesOutput<realA> SparseRealGridValuesOutput;
//! Non-zero complex grid values
...
typedef std::array<realA, DIM * DIM> Matrix3x3;
//! PME solver type
...
typedef std::tuple<realA, Matrix3x3> PmeSolveOutput;
...
PmeSafePointer pmeInitEmpty(const t_inputrec *inputRec,
                            ...
                            realA ewaldCoeff_q = 0.0f, realA ewaldCoeff_lj = 0.0f);
