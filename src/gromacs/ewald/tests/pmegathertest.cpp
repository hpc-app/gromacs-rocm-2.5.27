...
//! Random charges
static std::vector<realA> const c_sampleChargesFull
{
...
static std::vector<realA> const c_sampleSplineValuesFull
{
...
static std::vector<realA> const c_sampleSplineDerivativesFull
{
