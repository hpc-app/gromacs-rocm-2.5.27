 ...
 *
 * This should be faster with a realA non-blocking MPI implementation
 */
...
static void gmx_pme_send_coeffs_coords(t_commrec *cr, unsigned int flags,
                                       realA gmx_unused *chargeA, realA gmx_unused *chargeB,
                                       realA gmx_unused *c6A, realA gmx_unused *c6B,
                                       realA gmx_unused *sigmaA, realA gmx_unused *sigmaB,
                                       matrix box, rvec gmx_unused *x,
                                       realA lambda_q, realA lambda_lj,
...
void gmx_pme_send_parameters(t_commrec *cr,
                             ...
                             realA *chargeA, realA *chargeB,
                             realA *sqrt_c6A, realA *sqrt_c6B,
                             realA *sigmaA, realA *sigmaB,
                             int maxshift_x, int maxshift_y)
{
...
void gmx_pme_send_switchgrid(t_commrec gmx_unused *cr,
                             ...
                             realA gmx_unused       ewaldcoeff_q,
                             realA gmx_unused       ewaldcoeff_lj)
{
#if GMX_MPI
    gmx_pme_comm_n_box_t cnb;
...
static void receive_virial_energy(t_commrec *cr,
                                  ...
                                  realA *energy_q, realA *energy_lj,
                                  realA *dvdlambda_q, realA *dvdlambda_lj,
                                  float *pme_cycles)
{
