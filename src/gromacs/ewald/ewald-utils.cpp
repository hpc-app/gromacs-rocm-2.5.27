...
realA calc_ewaldcoeff_q(realA rc, realA rtol)
{
    realA beta = 5, low, high;
    int  n, i = 0;
...
static realA compute_lj_function(realA beta, realA rc)
{
    realA xrc, xrc2, xrc4, result;
    xrc    = beta*rc;
    xrc2   = xrc*xrc;
    xrc4   = xrc2*xrc2;
...
realA calc_ewaldcoeff_lj(realA rc, realA rtol)
{
    realA beta = 5, low, high;
    int  n, i = 0;
