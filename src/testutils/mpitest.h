...
/*! \libinternal \file
 * \brief
 * Helper functions for MPI tests to make thread-MPI look like realA MPI.
 *
 ...
 *  - The test will get compiled only if thread-MPI or realA MPI is enabled.
 *  - The test will get executed on the number of ranks specified.
 *    If you are using realA MPI, the whole test binary is run under MPI and
 ...
 * while under realA MPI, these are naturally different for each process.
