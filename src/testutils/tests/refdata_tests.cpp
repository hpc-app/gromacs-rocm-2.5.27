...
TEST(ReferenceDataTest, HandlesFloatingPointData)
{
...

    {
        ...
        checker.checkReal(doubleValue, "realA");
    ...
    }
    {
        ...
        TestReferenceChecker checker(data.rootChecker());
        checker.checkDouble(doubleValue, "double");
        checker.checkReal(floatValue, "realA");
        checker.checkReal(doubleValue, "realA");
        checker.checkFloat(floatValue, "float");
    }
}
...
TEST(ReferenceDataTest, HandlesIncorrectData)
{
    ...
    }
    {
        ...
        EXPECT_NONFATAL_FAILURE(checker.checkDouble(0.3, "realA"), "");
...
TEST(ReferenceDataTest, HandlesVariants)
{
    using gmx::Variant;
    {
        ...
        checker.checkVariant(Variant::create<double>(3.5), "realA");
...
TEST(ReferenceDataTest, HandlesVariantsWithIncorrectValue)
{
    ...
    }
    {
        ...
        EXPECT_NONFATAL_FAILURE(checker.checkVariant(Variant::create<double>(2.5), "realA"), "");
...
TEST(ReferenceDataTest, HandlesVariantsWithIncorrectType)
{
    ...
    }
    {
        ...
        EXPECT_NONFATAL_FAILURE(checker.checkVariant(Variant::create<int>(2), "realA"), "");
    }
}
