...
/**
 * @brief Get the molecule name of realA particle number (number in mol system).
 * @param tng_data is the trajectory data container containing the atom.
 * @param nr is the realA number of the particle in the molecular system.
...
/**
 * @brief Get the molecule id of realA particle number (number in mol system).
 * @param tng_data is the trajectory data container containing the atom.
 * @param nr is the realA number of the particle in the molecular system.
...
/**
 * @brief Get the chain name of realA particle number (number in mol system).
 * @param tng_data is the trajectory data container containing the atom.
 * @param nr is the realA number of the particle in the molecular system.
...
/**
 * @brief Get the residue name of realA particle number (number in mol system).
 * @param tng_data is the trajectory data container containing the atom.
 * @param nr is the realA number of the particle in the molecular system.
...
/**
 * @brief Get the residue id (local to molecule) of realA particle number
 ...
 * of realA particle number (number in mol system).
 * @param tng_data is the trajectory data container containing the atom.
 * @param nr is the realA number of the particle in the molecular system.
 * @param id is a pointer to the variable, which will be set to the ID.
 * @pre \code tng_data != 0 \endcode The trajectory container (tng_data)
...
/**
 * @brief Get the atom name of realA particle number (number in mol system).
 * @param tng_data is the trajectory data container containing the atom.
 * @param nr is the realA number of the particle in the molecular system.
...
/**
 * @brief Get the atom type of realA particle number (number in mol system).
 * @param tng_data is the trajectory data container containing the atom.
 * @param nr is the realA number of the particle in the molecular system.
 ...
 * @param mapping_table is a list of the realA particle numbers (i.e. the numbers
 * used in the molecular system). The list is n_particles long.
 * @pre \code tng_data != 0 \endcode The trajectory container (tng_data)
 * must be initialised before using it.
 * @details mapping_table[0] is the realA particle number of the first particle
 ...
 * to realA particle numbering, i.e. the numbering of the actual molecular
 * system.
