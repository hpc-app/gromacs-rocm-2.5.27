...
struct tng_particle_mapping {
    ...
    int64_t n_particles;
    /** the mapping of index numbers to the realA particle numbers in the
     * trajectory. real_particle_numbers[0] is the realA particle number
...
/**
 * @brief Read an atom mappings block (translating between realA atom indexes and how
...
/**
 * @brief Translate from the particle numbering used in a frame set to the realA
 ...
 * @param realA is set to the index of the atom in the molecular system.
                 ...
                 int64_t *realA)
{
    ...
    for(i = 0; i < n_blocks; i++)
    {
        ...
        *realA = mapping->real_particle_numbers[local-first];
        return(TNG_SUCCESS);
    }
    *realA = local;
    return(TNG_FAILURE);
...
/**
 * @brief Translate from the realA particle numbering to the particle numbering
 *  used in a frame set.
 * @param frame_set is the frame_set containing the mappings to use.
 * @param realA is the index number of the atom in the molecular system.
                 ...
                 int64_t *local)
{
    ...
    for(i = 0; i < n_blocks; i++)
    {
        ...
        {
            if(mapping->real_particle_numbers[j] == realA)
            {
                *local = j;
                return(TNG_SUCCESS);
            }
