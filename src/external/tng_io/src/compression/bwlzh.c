                               ...
                               const int verbose)
{
  ...
  /* Store the number of realA values in the whole block. */
  ...
  nvals16=99;
      ...
      /* Store the number of realA values in this block. */
                               ...
                               const int verbose)
{
  ...
  /* Read the number of realA values in the whole block. */
  ...
  while (valsleft)
    {
      int valsnew;
      int reducealgo;
      /* Read the number of realA values in this block. */
