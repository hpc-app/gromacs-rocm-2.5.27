...
void calc_f_dev(int natoms,realA charge[],rvec x[],rvec f[],
		t_idef *idef,realA *xiH,realA *xiS)
{
  enum { wwwO, wwwH1, wwwH2, wwwS, wwwNR };
  int  lj_index[wwwNR] = { 0,    4,     4,     8 };
  realA rmsf,dFH,dFS,dFO,dr_14;
  realA q[wwwNR],c6[wwwNR],c12[wwwNR],c12ratio;
  rvec fff[2],dx;
  int  i,j,aj;
