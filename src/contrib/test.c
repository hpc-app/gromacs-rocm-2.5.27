...
realA pot(realA x,realA qq,realA c6,realA c12)
{
  return c12*pow(x,-12)-c6*pow(x,-6)+qq*ONE_4PI_EPS0/x;
}

realA dpot(realA x,realA qq,realA c6,realA c12)
{
...
int main(int argc,char *argv[])
{
  ...
  static realA c6=1.0e-3,c12=1.0e-6,qi=1,qj=2,sig=0.3,eps=1,sigfac=0.7;
  t_pargs pa[] = {
...
#define NFILE asize(fnm)
  ...
  FILE      *fp;
  int       i;
  realA      qq,x,oldx,minimum,mval,dp[2],pp[2];
  int       cur=0;
#define next (1-cur)
