...
C
     ...
     $     Vc,Vnb)
      ...
      realA      ix,iy,iz,qi
      realA      pos(*),charge(*),faction(*),fip(3)
      ...
      realA      twelve,six
      realA      fX,fY,fZ
      realA      rijX,rijY,rijZ
      realA      fijscal,vijcoul
      realA      vctot,vnbtot
      realA      rinv1,rinv2,rinv6
      realA      fjx,fjy,fjz
      realA      tx,ty,tz,vnb6,vnb12
...
c$dir ivdep
      ...
      realA*4 ix,iy,iz,qi,pos(maxx),faction(maxx),fip(3)
      realA*4 charge(maxatom),nbfp(2*maxtype),Vc,Vnb
