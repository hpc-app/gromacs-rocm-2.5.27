...
t_histo *init_histo(int np,realA minx,realA maxx)
{
  t_histo *h;
...
void add_histo(t_histo *h,realA x,realA y)
{
  int n;
...
t_ana_struct *init_ana_struct(int nstep,int nsave,realA timestep,
			      int maxparticle)
{
  t_ana_struct *anal;
...
void analyse_structure(t_ana_struct *anal,realA t,rvec center,
...
void add_ana_ener(t_ana_ener *ae,int nn,realA e[])
{
  int i;
...
void dump_ana_ener(t_ana_ener *ae,int nsim,realA dt,char *edump,
		   t_ana_struct *total)
{
  FILE *fp;
  int  i,j;
