...
static void rotate_x(int natom,rvec xin[],realA angle,rvec xout[],
		     gmx_bool bZ,gmx_bool bUpsideDown,realA dz)
{
  int i;
  matrix mat;
...
static void prep_x(int natom,rvec x[],realA rDist,realA rAngleZ,realA rAngleX)
{
  int  i;
  rvec xcm;
  rvec *xx;
...
#define NFILE asize(fnm)
  ...
  realA rDist = 0,rAngleZ = 0,rAngleX = 0, alterz = 0;
  t_pargs pa[] = {
