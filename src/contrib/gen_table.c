...
static void do_ljc(FILE *fp,int eel,int pts_nm,realA rc,realA rtol)
{ 
  int    i,i0,imax;
  double r,vc,fc,vd,fd,vr,fr;
...
int main(int argc,char *argv[])
{
  ...
  static char *model[]   = { NULL, "ljc", "gg", "guillot2001a",  
			     NULL };
  static realA delta=0,efac=500,rc=0.9,rtol=1e-05,xi=0.15,xir=0.0615;
  static realA w1=20,w2=20;
