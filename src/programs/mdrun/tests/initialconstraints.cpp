...
TEST_P(InitialConstraintsTest, Works)
{
    ...
    realA totalEnergy  = 0.0, prevTotalEnergy = 0.0;
    auto tolerance    = ulpTolerance(0); // The realA value is set below from starting kinetic energy
    for (int i = 0; i <= nsteps; i++)
    {
        ...
        if (i == 0)
        {
            ...
            const realA startingKineticEnergy = frame.at("Kinetic En.");
