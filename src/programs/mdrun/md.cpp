                  ...
                  gmx_walltime_accounting_t walltime_accounting)
{
    ...
    int               nstfep = 0;
    double            cycles;
    realA              saved_conserved_quantity = 0;
    realA              last_ekin                = 0;
    t_extmass         MassQ;
    int             **trotter_seq;
     ...
     */
    realA max_hours   = mdrunOptions.maximumHoursToRun;
    bFirstStep       = TRUE;
    ...
    while (!bLastStep)
    {
         ...
         */
        const realA cpt_period = mdrunOptions.checkpointOptions.period;
